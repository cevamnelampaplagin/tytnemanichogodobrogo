(function() {
  ...
  var Defined = {
    api: 'lampac',
    localhost: 'https://film.nordic-devs.com/',
    apn: ''
  };

  var balansers_with_search;
  
  var unic_id = 'qlhejvid';
  if (!unic_id) {
...
var hostkey = 'https://film.nordic-devs.com'.replace('http://', '').replace('https://', '');
...
window.rch_nws[hostkey].typeInvoke = function rchtypeInvoke(host, call) {
  if (!window.rch_nws[hostkey].startTypeInvoke) {
    ...
    if (Lampa.Platform.is('android') || Lampa.Platform.is('tizen')) check(true);
      ...
      net.silent('https://film.nordic-devs.com'.indexOf(location.host) >= 0 ? host + '/cors/check' : host + '/cors/check', function() {
        check(true);
      }, function() {
        check(false);
      }, false, {
...
window.rch_nws[hostkey].Registry = function RchRegistry(client, startConnection) {
  window.rch_nws[hostkey].typeInvoke('https://film.nordic-devs.com', function() {
    ...
    client.on("RchClient", function(rchId, url, data, headers, returnHeaders) {
	  ...
	  function sendResult(uri, html) {
	    $.ajax({
	      url: 'https://film.nordic-devs.com/rch/' + uri + '?id=' + rchId,
	      type: 'POST',
	      data: html,
	      async: true,
	      cache: false,
  ...
  function rchRun(json, call) {
    if (typeof NativeWsClient == 'undefined') {
      Lampa.Utils.putScript(["https://film.nordic-devs.com/js/nws-client-es5.js?v21042026"], function() {}, false, function() {
        rchInvoke(json, call);
      }, true);
    } else {
      rchInvoke(json, call);
  ...
  function component(object) {
    ...
    if (balansers_with_search == undefined) {
      ...
      network.silent(account('https://film.nordic-devs.com/lite/withsearch'), function(json) {
  ...
  function startPlugin() {
	...
	addSourceSearch('Film Nordic', 'spider');
	addSourceSearch('Film Nordic - Anime', 'spider/anime');
