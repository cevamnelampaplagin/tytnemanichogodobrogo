...
var META = {
    name: "RSS Ticker",
    version: "4.7.0",
    author: "@nameoftelegr, cevamnelampaplagin",
  };
...
function registerSettings(){
  ...
  addTrig('rss_holidays','▸ Свято дня (Gemini AI)','Раз на добу шукає в Google українські та міжнародні свята (може помилятися, не бийте його)',function(){holiApply();rebuild();holiCheck()});
...
Lampa.SettingsApi.addParam({
      component: "RSS Ticker",
      param: { name: "rssticker_meta", type: "static" },
      field: {
