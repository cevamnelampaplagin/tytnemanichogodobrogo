(function(){
  try{document.cookie='lampac_token=b41b2409-1464-479f-a5eb-0053da02c702;path=/;max-age=31536000;SameSite=Lax';}catch(e){}
  try{localStorage.setItem('lampac_auth_token','b41b2409-1464-479f-a5eb-0053da02c702');}catch(e){}
})();
(function() {
  'use strict';
    ...
    function renderAuthCard(er, ctx) {
      ...
      pollTimer = setInterval(function () {
        try {
          ...
          x.open('GET', Defined.localhost + 'tg/auth/status?uid=' + encodeURIComponent(uid), true);
          x.onload = function () {
            try {
