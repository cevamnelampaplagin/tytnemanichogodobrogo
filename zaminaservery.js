...
function startMe() {
  ...
  Lampa.SettingsApi.addParam({
				...
				param: {
					...
					type: 'input', 
					values: '',
					placeholder: 'Наприклад: lampa.mx',
					default: ''
				},
				field: {
					name: 'Адреса сервера',
					description: 'Натисніть, щоб ввести, зміну сервера можна буде зробити кнопкою у верхньому барі'
				},
    ...
    Lampa.SettingsApi.addParam({
			...
			field: {
				name: 'Постійне переадресування',
				description: 'Щоб вимкнути постійний редирект, затисніть клавішу ВНИЗ під час завантаження програми' 
			}
   });
