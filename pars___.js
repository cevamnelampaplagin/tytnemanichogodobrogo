(function () {
    ...
    function wipeAllPluginStorage() {
        ALL_PLUGIN_KEYS.forEach(function (key) {
            try { Lampa.Storage.set(key, null); } catch (e) {}
        });
    }
    ...
    function resetParsersToDefault() {
        ...
        // 4. Записуємо свіжий DEFAULT_PARSERS (так, як він є в поточному файлі плагіна)
        ...
        // 5. Оновлюємо весь UI, що відображає стан плагіна
