/**
 * Ліхтар Studios2 — развлекательная программа (Flixio Team).
 * Кастомна головна, стремления, студии, записи на студии, Киноосмотр.
 */
(функция () {
    'use strict';
    ...
    if (typeof Lampa === 'undefined') {
        window.FLIXIO_STUDIOS_ERROR = 'Lampa не найдена (скрипт загружен до приложения?)';
        возвращаться;
    }
    ...
    // url = https://github.com/arnold77-fc/Lp_plagin3/blob/main/for.js
    // =================================================================
    ...
    // Принудительное использование CDN для обеспечения корректной загрузки логотипов независимо от способа установки
...
/*
    ...
    if (FLIXIO_BASE_URL.indexOf('raw.githubusercontent.com') !== -1) {
        ...
        // например, https://syvyj.github.io/studio_2/ → https://cdn.jsdelivr.net/gh/syvyj/studio_2@main/
...
*/
    ...
    если (FLIXIO_LANG === 'ua') FLIXIO_LANG = 'uk';
    if (['uk', 'ru', 'en', 'pl'].indexOf(FLIXIO_LANG) === -1) FLIXIO_LANG = 'en';

    var FLIXIO_I18N = {
        Hero_row_title: { uk: 'Новинки проката', ru: 'Новинки проката', en: 'Новые театральные релизы', pl: 'Новинки проката' },
        Hero_row_title_full: { uk: '🔥 Новинки проката', ru: '🔥 Новинки проката', en: '🔥 Новые театральные релизы', pl: '🔥 Nowości kinowe' },
        streamings_row_title: { uk: 'Стриминги', ru: 'Стриминги', en: 'Streaming', pl: 'Serwisystreamingowe' },
        streamings_row_title_full: { uk: '📺 Стриминги', ru: '📺 Стриминги', en: '📺 Streaming', pl: '📺 Serwisystreamingowe' },
        ukrainian_feed_name: { uk: 'Украинская стрічка', ru: 'Украинская лента', en: 'Украинский канал', pl: 'Украинский канал' },
        Polish_feed_name: { uk: 'Польска стрічка', ru: 'Польская лента', en: 'Польский канал', pl: 'Польский канал' },
        russian_feed_name: { uk: 'Російська стрічка', ru: 'Русская лента', en: 'Русский канал', pl: 'Росийский канал' },
        ru_new_movies: { uk: '🔥 Нові фильмы', ru: '🔥 Новые фильмы', en: '🔥 Новые фильмы', pl: '🔥 Nowe Filmy' },
        ru_new_tv: { uk: '🔥 Нові серіали', ru: '🔥 Новые сериалы', en: '🔥 Новые серии', pl: '🔥 Новые сериалы' },
        ru_shows: { uk: '🎤 Шоу та Реаліті', ru: '🎤 Шоу и реалити', en: '🎤 Шоу и реальность', pl: '🎤 Шоу и реальность' },
        ru_trending_movies: { uk: '📈 Популярные фильмы', ru: '📈 Популярные фильмы', en: '📈 Популярные фильмы', pl: '📈 Популярные фильмы' },
        ru_trending_series: { uk: '📈 Популярные сериалы', ru: '📈 Популярные сериалы', en: '📈 Популярные сериалы', pl: '📈 Популярные сериалы' },
        ru_best_movies: { uk: '⭐ Найкращі фильмы', ru: '⭐ Лучшие фильмы', en: '⭐ Лучшие фильмы', pl: '⭐ Найлепские фильмы' },
        ru_all_movies: { uk: '🎬 Все фильмы (Ru)', ru: '🎬 Все фильмы (Ru)', en: '🎬 Все фильмы (Ru)', pl: '🎬 Wszystkie Filmy (Ru)' },
        ru_all_series: { uk: '📺 Все сериалы (Ru)', ru: '📺 Все сериалы (Ru)', en: '📺 Все серии (Ru)', pl: '📺 Самые популярные сериалы (Ru)' },
        ru_all_shows: { uk: '🎤 Всі шоу (Ru)', ru: '🎤 Все шоу (Ru)', en: '🎤 Все шоу (Ru)', pl: '🎤 Wszystkie show (Ru)' },
        ukrainian_row_title: { uk: 'Новинки українской стрічки', ru: 'Новинки украинской ленты', en: 'Новинки в украинской ленте', pl: 'Новинки в украинской секции' },
        ukrainian_row_title_full: { uk: '🇺🇦 Новинки української стрічки', ru: '🇺🇦 Новинки украинской ленты', en: '🇺🇦 Новое в украинской ленте', pl: '🇺🇦 Nowości w ukraińskiej sekcji' },
        Polish_row_title: { uk: 'Новинки польской стрічки', ru: 'Новинки польской ленты', en: 'Новинки в польской ленте', pl: 'Nowości w polskiej sekcji' },
        Polish_row_title_full: { uk: '🇵🇱 Новинки польской стрічки', ru: '🇵🇱 Новинки польской ленты', en: '🇵🇱 Новое в польской ленте', pl: '🇵🇱 Nowości w polskiej seccji' },
        russian_row_title: { uk: 'Новинки российской ленты', ru: 'Новинки Русской ленты', en: 'Новинки в русской ленте', pl: 'Новинки в росийских разделах' },
        russian_row_title_full: { uk: '🇷🇺 Новинки російської стрічки', ru: '🇷🇺 Новинки Русской ленты', en: '🇷🇺 Новое в русской ленте', pl: '🇷🇺 Новосьцы в росийских разделах' },
        english_row_title: { uk: 'Новинки англомовной стрічки', ru: 'Новинки Английской ленты', en: 'Новинки в английской ленте', pl: 'Nowości w anglojęzycznej sekcji' },
        english_row_title_full: { uk: 'En Новинки англомовной стрічки', ru: 'En Новинки Английской ленты', en: 'Новинки в английской ленте', pl: 'En Nowości w anglojęzycznej sekcji' },
        mood_row_title: { uk: «Кино под настрій», ru: «Кино по настроению», en: «Фильмы настроения», pl: «Кино на настрой» },
        mood_row_title_full: { uk: '🎭 Кино під настрій', ru: '🎭 Кино по настроению', en: '🎭 Кино настроения', pl: '🎭 Кино настрой' },
        mood_cry: { uk: 'До сліз / Катарсис', ru: 'До слёз / Катарсис', en: 'До слёз/Катарсис', pl: 'Do łez / Катарсис' },
        настроение_позитив: { uk: 'Чистый позитив', ru: 'Чистый позитив', en: 'Чистый позитив', pl: 'Чистый позитив' },
        mood_tasty: { uk: 'Смачный просмотр', ru: 'Вкусный просмотр', en: 'Вкусные часы', pl: 'Smaczne oglądanie' },
        настроение_адреналин: { uk: «Адреналин», ru: «Адреналин», en: «Адреналин», pl: «Адреналин» },
        mood_butterflies: { uk: 'Метелики в животі', ru: 'Бабочки в животе', en: 'Бабочки в животе', pl: 'Motyle w brzuchu' },
        mood_tension: { uk: 'На межі / Напруга', ru: 'На грани / Напряженность', en: 'На краю/Напряжение', pl: 'На krawędzi / Napięcie' },
        mood_adventure: { uk: 'Пошук пригод', ru: 'В поисках приключений', en: 'В поисках приключений', pl: 'W poszukiwaniu przygód' },
        mood_together: { uk: 'Разом веселіше', ru: 'Вместе веселее', en: 'Вместе веселее', pl: 'Razem weselej' },
        mood_family: { uk: 'Малим і дорослим', ru: 'Малым и взрослым', en: 'Для детей и взрослых', pl: 'Для малышей и душ' },
        mood_your_choice: { uk: 'На твій вкус', ru: 'На твой вкус', en: 'На твой вкус', pl: 'Według twojego gustu' },
        Today_on_prefix: { uk: 'Сегодня на', ru: 'Сегодня на', en: 'Сегодня', pl: 'Дзись на' },
        go_to_page: { uk: «На странице», ru: «На странице», en: «Открыть страницу», pl: «На странице» },
        cat_new_movies: { uk: '🔥 Нові фильмы', ru: '🔥 Новые фильмы', en: '🔥 Новые фильмы', pl: '🔥 Nowe Filmy' },
        cat_new_tv: { uk: '🔥 Нові серіали', ru: '🔥 Новые сериалы', en: '🔥 Новые серии', pl: '🔥 Новые сериалы' },
        cat_top_tv: { uk: '🏆 Топ сериалы', ru: '🏆 Топ сериалы', en: '🏆 Топ сериалы', pl: '🏆 Топ сериалы' },
        cat_top_movies: { uk: '🏆 Топ фильмов', ru: '🏆 Топ фильмов', en: '🏆 Топ фильмов', pl: '🏆 Топ фильмов' },
        cat_top_movies_wb: { uk: '🏆 Топ фильмов (WB)', ru: '🏆 Топ фильмов (WB)', en: '🏆 Лучшие фильмы (WB)', pl: '🏆 Топ фильмов (WB)' },
        ...
        cat_twisted_thrillers: { uk: '🤯 Заплутаны триллеры', ru: '🤯 Запутанные триллеры', en: '🤯 Закрученные триллеры', pl: '🤯 Покрэнконские триллеры' },
        cat_fantasy_sci: { uk: '🐉 Фантастика та Фэнтезі', ru: '🐉 Фантастика и фэнтези', en: '🐉 Научная фантастика и фэнтези', pl: '🐉 Научная фантастика и фэнтези' },
        cat_kdrama: { uk: '🇰🇷 K-Dramas (Корея)', ru: '🇰🇷 K‑Дорамы (Корея)', en: '🇰🇷 K‑Dramas (Корея)', pl: '🇰🇷 K‑dramy (Корея)' },
        cat_truecrime_doc: { uk: '🔪 Документальный True Crime', ru: '🔪 Документальный True Crime', en: '🔪 Документальные фильмы о реальных преступлениях', pl: '🔪 True Crime – документы' },
        cat_anime: { uk: '🍿 Аніме', ru: '🍿 Аниме', en: '🍿 Аниме', pl: '🍿 Аниме' },
        cat_apple_epic_sci: { uk: '🛸 Епічний Sci-Fi (Фирменный Apple)', ru: '🛸 Эпический Sci‑Fi (фирменный Apple)', en: '🛸 Epic Sci‑Fi (специализация Apple)', pl: '🛸 Epickie Sci‑Fi (Apple)' },
        cat_comedy_feelgood: { uk: '😂 Комедия та Feel-Good', ru: '😂 Комедии и хорошее настроение', en: '😂 Комедии и хорошее настроение', pl: '😂 Комедии и хорошее настроение' },
        cat_quality_detectives: { uk: '🕵️ Якісні детективы', ru: '🕵️ Качественные детективы', en: '🕵️ Качественные детективные шоу', pl: '🕵️ Добре криминалы' },
        cat_apple_original: { uk: '🎬 Apple Original Films', ru: '🎬 Apple Original Films', en: '🎬 Apple Original Films', pl: '🎬 Apple Original Films' },
        cat_epic_sagas: { uk: '🐉 Епічні саги (Фентезі)', ru: '🐉 Эпические саги (фэнтези)', en: '🐉 Эпические фэнтезийные саги', pl: '🐉 Эпические саги фэнтези' },
        cat_premium_dramas: { uk: '🎭 Преміальні драми', ru: '🎭 Премиальные драмы', en: '🎭 Премиальные драмы', pl: '🎭 Премиальные драмы' },
        cat_dc_blockbusters: { uk: '🦇 Блокбастеры DC', ru: '🦇 Блокбастеры DC', en: '🦇 Блокбастеры DC', pl: '🦇 Блокбастеры DC' },
        cat_dark_detectives: { uk: '🧠 Похмурі детективи', ru: '🧠 Мрачные детективы', en: '🧠 Темные детективы', pl: '🧠 Мрачные детективы' },
        cat_hbo_classics: { uk: '👑 Золотая классика HBO', ru: '👑 Золотая классика HBO', en: '👑 Золотая классика HBO', pl: '👑 Золотая классика HBO' },
        cat_hard_action: { uk: '🩸 Жорсткий экшн та Антигерої', ru: '🩸 Жёсткий экшн и антигерои', en: '🩸 Жесткий экшн и антигерои', pl: '🩸 Острый экшн и антигерои' },
        cat_amazon_mgm: { uk: '🎬 Фильмы от Amazon MGM', ru: '🎬 Фильмы от Amazon MGM', en: '🎬 Фильмы Amazon MGM', pl: '🎬 Filmy Amazon MGM' },
        cat_comedies: { uk: '😂 Комедии', ru: '😂 Комедии', en: '😂 Комедии', pl: '😂 Комедии' },
        cat_thrillers: { uk: '🕵️ Триллери', ru: '🕵️ Триллеры', en: '🕵️ Триллеры', pl: '🕵️ Триллеры' },
        cat_adult_animation: { uk: '🤬 Анимация для дорослих', ru: '🤬 Анимация для взрослых', en: '🤬 Анимация для взрослых', pl: '🤬 Animacje dla dorosłych' },
        cat_marvel_universe: { uk: '🦸‍♂️ Кіновсесвіт Marvel', ru: '🦸♂️ Киновселенная Marvel', en: '🦸‍♂️ Кинематографическая вселенная Marvel', pl: '🦸‍♂️ Uniwersum Marvela' },
        cat_starwars: { uk: '⚔️ Далека галактика (Звездные войны)', ru: '⚔️ Далёкая галактика (Звездные войны)', en: '⚔️ Далекая галактика (Звездные войны)', pl: '⚔️ Odległa galaktyka (Звездные войны)' },
        cat_pixar: { uk: '🧸 Шедеври Pixar', ru: '🧸 Шедевры Pixar', en: '🧸 Шедевры Pixar', pl: '🧸 Arcydzieła Pixara' },
        cat_fx_star: { uk: '🍷 Дорослый контент (FX/Star)', ru: '🍷 Взрослый контент (FX/Star)', en: '🍷 Контент для взрослых (FX/Star)', pl: '🍷 Treści dla dorosłych (FX/Star)' },
        cat_sheridan_universe: { uk: '🤠 Всесвіт Шеридана (Йеллоустоун)', ru: '🤠 Вселенная Шеридана (Йеллоустоун)', en: '🤠 Вселенная Шеридана (Йеллоустоун)', pl: '🤠 Uniwersum Sheridana (Йеллоустоун)' },
        cat_startrek_collection: { uk: '🖖 Коллекция Star Trek', ru: '🖖 Коллекция Star Trek', en: '🖖 Коллекция Star Trek', pl: '🖖 Коллекция Star Trek' },
        cat_crime_investigation: { uk: '🚓 Криминал та Розыск', ru: '🚓 Криминал и расследования', en: '🚓 Преступность и расследование', pl: '🚓 Криминал и расследование' },
        ...
        cat_paramount_blockbusters: { uk: '🎬 Блокбастеры (Paramount)', ru: '🎬 Блокбастеры (Paramount)', en: '🎬 Блокбастеры (Paramount)', pl: '🎬 Блокбастеры (Paramount)' },
        cat_universal_world: { uk: '🌍 Світ Universal', ru: '🌍 Мир Universal', en: '🌍 Universal world', pl: '🌍 Świat Universal' },
        cat_showtime_adult: { uk: '🕵️ Дорослий розбір (Showtime)', ru: '🕵️ Взрослый разбор (Showtime)', en: '🕵️ Взрослый разбор (Showtime)', pl: '🕵️ Анализ для дорослых (Showtime)' },
        cat_dreamworks_worlds: { uk: '🦄 Казкові світи (DreamWorks)', ru: '🦄 Сказочные миры (DreamWorks)', en: '🦄 Сказочные миры (DreamWorks)', pl: '🦄 Bajkowe światy (DreamWorks)' },
        cat_new_releases_syfy: { uk: '🔥 Новинки', ru: '🔥 Новинки', en: '🔥 Новые выпуски', pl: '🔥 Nowości' },
        cat_top_syfy: { uk: '🏆 Топ на Syfy', ru: '🏆 Топ на Syfy', en: '🏆 Топ на Syfy', pl: '🏆 Топ на Syfy' },
        cat_space_travel: { uk: '🚀 Космічні подорожі', ru: '🚀 Космические путешествия', en: '🚀 Космические путешествия', pl: '🚀 Podróże kosmiczne' },
        cat_monsters_paranormalne: { uk: '🧟 Монстры та паранормальное', ru: '🧟 Монстры и паранормальное', en: '🧟 Монстры и паранормальные явления', pl: '🧟 Potwory i zjawiska paranormalne' },
        Education_title: { uk: 'Пізнавальне', ru: 'Познавательное', en: 'Educational', pl: 'Edukacyjne' },
        cat_new_episodes: { uk: '🔥 Нові випуски', ru: '🔥 Новые выпуски', en: '🔥 Новые эпизоды', pl: '🔥 Nowe odcinki' },
        cat_cooking_battles: { uk: '🔪 Кулинарные битви', ru: '🔪 Кулинарные сражения', en: '🔪 Кулинарные битвы', pl: '🔪 Кученне поединки' },
        cat_survival: { uk: '🪓 Выживание', ru: '🪓 Выживание', en: '🪓 Выживание', pl: '🪓 Przetrwanie' },
        ua_new_movies: { uk: 'Новые украинские фильмы', ru: 'Новые украинские фильмы', en: 'Новые украинские фильмы', pl: 'Новые украинские фильмы' },
        ua_new_tv: { uk: «Новые украинские сериалы», ru: «Новые украинские сериалы», en: «Новые украинские сериалы», pl: «Новые украинские сериалы» },
        ua_shows: { uk: 'Шоу та программы', ru: 'Шоу и программы', en: 'Шоу и программы', pl: 'Шоу и программы' },
        ua_trending_movies: { uk: «В трендах в Украине», ru: «В тренде в Украине», en: «Тренды в Украине», pl: «На топи на Украине» },
        ua_trending_series: { uk: 'Украинские сериалы в тренде', ru: 'Украинские сериалы в тренде', en: 'Трендовые украинские сериалы', pl: 'Украинские сериалы на топи' },
        ua_best_movies: { uk: 'Найкращи украинские фильмы', ru: 'Лучшие украинские фильмы', en: 'Лучшие украинские фильмы', pl: 'Найлепские украинские фильмы' },
        ua_all_movies: { uk: 'Украинские фильмы (повна подборка)', ru: 'Украинские фильмы (полная подборка)', en: 'Украинские фильмы (полная коллекция)', pl: 'Украинские фильмы (пелна коллекция)' },
        ua_all_series: { uk: 'Украинские сериалы (повна подбірка)', ru: 'Украинские сериалы (полная подборка)', en: 'Украинские сериалы (полный сборник)', pl: 'Украинские сериалы (полная коллекция)' },
        pl_new_movies: { uk: 'Новые польские фильмы', ru: 'Новые польские фильмы', en: 'Новые польские фильмы', pl: 'Новые польские фильмы' },
        pl_new_tv: { uk: 'Новые польские сериалы', ru: 'Новые польские сериалы', en: 'Новые польские сериалы', pl: 'Новые польские сериалы' },
        pl_shows: { uk: 'Польские шоу та программы', ru: 'Польские шоу и программы', en: 'Польские шоу и программы', pl: 'Польские шоу и программы' },
        pl_trending_movies: { uk: «В тренде в Польше», ru: «В тренде в Польше», en: «Тренды в Польше», pl: «На топи в Польше» },
        pl_trending_series: { uk: 'Польские сериалы в тренде', ru: 'Польские сериалы в тренде', en: 'Трендовые польские сериалы', pl: 'Польские сериалы на тему' },
        pl_best_movies: { uk: 'Найкращі польские фильмы', ru: 'Лучшие польские фильмы', en: 'Лучшие польские фильмы', pl: 'Найлепские польские фильмы' },
        pl_all_movies: { uk: 'Польские фильмы (повна підбірка)', ru: 'Польские фильмы (полная подборка)', en: 'Польские фильмы (полная коллекция)', pl: 'Польские фильмы (пелна коллекция)' },
        pl_all_series: { uk: 'Польские сериалы (повна підбірка)', ru: 'Польские сериалы (полная подборка)', en: 'Польские сериалы (полный сборник)', pl: 'Польские сериалы (полная коллекция)' },
        pl_all_shows: { uk: 'Польские шоу и программы (повна підбірка)', ru: 'Польские шоу и программы (полная подборка)', en: 'Польские шоу и программы (полная коллекция)', pl: 'Польские шоу и программы (pełna kolekcja)' },
        settings_tab_title: { uk: «Ліхтар», ru: «Flixio», en: «Flixio», pl: «Flixio» },
        settings_header_info: { uk: 'Лихтар — кастомная головная очередь со стримингами, метками и украинской озвучкой. Автор: Flixio Team', ru: 'Flixio — кастомная главная страница со стримингами, метками качества и украинской озвучкой. Автор: Flixio Team', en: 'Flixio — кастомный домашний экран с трансляциями, значками качества и украинским звуком. Автор: Flixio Team', pl: 'Flixio — нестандартная строгая строка со стримингами, обозначениями японского и украинского дубляжа. Автор: Flixio Team' },
        settings_sections_title: { uk: «Секции головной страницы», ru: «Секции главной страницы», en: «Разделы главного экрана», pl: «Секции главного экрана» },
        settings_streamings_name: { uk: «Стриминги», ru: «Стриминги», en: «Streaming», pl: «Serwisystreamingowe» },
        settings_streamings_desc: { uk: 'Секция с логотипами стриминговых сервисов', ru: 'Секция с логотипами стриминговых сервисов', en: 'Строка с логотипами стриминговых сервисов', pl: 'Секция с логотипами стриминговых сервисов' },
        settings_hero_name: { uk: «Новинки проката», ru: «Новинки проката», en: «Новые театральные релизы», pl: «Новинки проката» },
        settings_hero_desc: { uk: 'Ряд инновационных прокатов на початку головной', ru: 'Ряд с новаторскими прокатами в начале главной', en: 'Ряд с театральными новинками наверху', pl: 'Rząd z novościami kinowymi na początku ekranu' },
        settings_row_ru_name: { uk: «Новинки российской ленты», ru: «Новинки Русской ленты», en: «Новинки в русской ленте», pl: «Новинки росийских секций» },
        settings_row_ru_desc: { uk: 'Показать ряд «Новинки Русской ленты»', ru: 'Показывать ряд «Новинки Русской ленты»', en: 'Показать строку «Новинки в русской ленте»', pl: 'Показать ряд «Новинки русских секций»' },
        settings_row_ua_name: { uk: 'Новинки украинской ленты', ru: 'Новинки Украинской ленты', en: 'Новинки в украинской ленте', pl: 'Новинки украинской ленты' },
        settings_row_ua_desc: { uk: 'Показать ряд «Новинки украинской стрічки»', ru: 'Показывать ряд «Новинки Украинской ленты»', en: 'Показать строку «Новинки в украинской ленте»', pl: 'Показать ряд «Новинки украинской ленты»' },
        settings_row_en_name: { uk: «Новинки английской ленты», ru: «Новинки Английской ленты», en: «Новинки в английской ленте», pl: «Новинки английской ленты» },
        settings_row_en_desc: { uk: 'Показать ряд «Новинки Английской ленты»', ru: 'Показать ряд «Новинки Английской ленты»', en: 'Показать строку «Новинки в английской ленте»', pl: 'Показать ряд «Новинки Английской ленты»'' },
        settings_row_pl_name: { uk: 'Новинки польской ленты', ru: 'Новинки польской ленты', en: 'Новинки в польской ленте', pl: 'Новинки польской ленты' },
        settings_row_pl_desc: { uk: 'Показать ряд «Новинки польской стрічки»', ru: 'Показать ряд «Новинки польской ленты»', en: 'Показать строку «Новинки в польской ленте»', pl: 'Показать ряд «Новинки польской ленты»' },
        settings_today_netflix_name: { uk: «Сегодня на Netflix», ru: «Сегодня на Netflix», en: «Сегодня на Netflix», pl: «Дзись на Netflix» },
        settings_today_netflix_desc: { uk: «Ряд новинок Netflix за сегодня», ru: «Ряд новинок Netflix за сегодня», en: «Спор с сегодняшними выпусками Netflix», pl: «Rząd dzisiejszych nowości Netflix» },
        settings_today_apple_name: { uk: «Сегодня на Apple TV+», ru: «Сегодня на Apple TV+», en: «Сегодня на Apple TV+», pl: «Дзись на Apple TV+» },
        settings_today_apple_desc: { uk: «Ряд новостей Apple TV+ за сегодня», ru: «Ряд новостей Apple TV+ за сегодня», en: «Ссора с сегодняшними выпусками Apple TV+», pl: «Rząd dzisiejszych nowości Apple TV+» },
        settings_today_hbo_name: { uk: «Сегодня на HBO / Max», ru: «Сегодня на HBO / Max», en: «Сегодня на HBO / Max», pl: «Dziś na HBO / Max» },
        settings_today_hbo_desc: { uk: «Ряд новинок HBO / Max за сегодня», ru: «Ряд новинок HBO / Max за сегодня», en: «Ссора с сегодняшними релизами HBO / Max», pl: «Rząd dzisiejszych nowości HBO / Max» },
        settings_today_prime_name: { uk: «Сегодня на Prime Video», ru: «Сегодня на Prime Video», en: «Сегодня на Prime Video», pl: «Дзись на Prime Video» },
        settings_today_prime_desc: { uk: «Ряд новинок Prime Video за сегодня», ru: «Ряд новинок Prime Video за сегодня», en: «Сегодняшние релизы Prime Video», pl: «Rząd dzisiejszych nowości Prime Video» },
        settings_today_disney_name: { uk: «Сегодня на Disney+», ru: «Сегодня на Disney+», en: «Сегодня на Disney+», pl: «Дзись на Disney+» },
        settings_today_disney_desc: { uk: 'Ряд новинок Disney+ за сегодня', ru: 'Ряд новинок Disney+ за сегодня', en: 'Ссора с сегодняшними релизами Disney+', pl: 'Rząd dzisiejszych nowości Disney+' },
        settings_today_paramount_name: { uk: «Сегодня на Paramount+», ru: «Сегодня на Paramount+», en: «Сегодня на Paramount+», pl: «Дзись на Paramount+» },
        settings_today_paramount_desc: { uk: 'Ряд новинок Paramount+ за сегодня', ru: 'Ряд новинок Paramount+ за сегодня', en: 'Спор с сегодняшними релизами Paramount+', pl: 'Rząd dzisiejszych nowości Paramount+' },
        settings_today_sky_name: { uk: «Сегодня на Sky Showtime», ru: «Сегодня на Sky Showtime», en: «Сегодня на Sky Showtime», pl: «Дзись на Sky Showtime» },
        settings_today_sky_desc: { uk: 'Ряд новинок Sky Showtime за сегодня', ru: 'Ряд новинок Sky Showtime за сегодня', en: 'Ссора с сегодняшними релизами Sky Showtime', pl: 'Rząd dzisiejszych nowości Sky Showtime' },
        settings_today_hulu_name: { uk: «Сегодня на Hulu», ru: «Сегодня на Hulu», en: «Сегодня на Hulu», pl: «Dziś na Hulu» },
        settings_today_hulu_desc: { uk: 'Ряд новинок Hulu за сегодня', ru: 'Ряд новинок Hulu за сегодня', en: 'Ссора с сегодняшними релизами Hulu', pl: 'Rząd dzisiejszych nowości Hulu' },
        settings_mood_name: { uk: «Кино под настрій», ru: «Кино по настроению», en: «Кино по настроению», pl: «Кино на настрой» },
        settings_mood_desc: { uk: 'Подбор фильмов по жанрам и настроению', ru: 'Подборки фильмов по жанрам и настроению', en: 'Выбор фильмов по жанрам и настроению', pl: 'Zestawy Filmów wg gatunku и nastroju' },
        settings_kinooglad_name: { uk: 'Кіноогляд', ru: 'Кинообзор', en: 'Обзор фильма', pl: 'Przegląd Filmowy' },
        settings_kinooglad_desc: { uk: 'Увімкнути разділ Кіноогляд в меню. Налаштування каналов нижче.', ru: 'Включить раздел Кинообзор в меню. Настройки параметров ниже.', en: 'Включите в меню раздел «Обзор фильмов». Настройки канала ниже.', pl: 'Włącz sekcję Przegląd Filmowy w меню. Установка каналов ниже.' },
        settings_badges_title: { uk: «Мітки на карточках», ru: «Метки на карточках», en: «Бейджи на карточках», pl: «Этики на картах» },
        settings_badge_ru_name: { uk: 'Російська озвучка (RU)', ru: 'Русская озвучка (RU)', en: 'Русское аудио (RU)', pl: 'Росийский дубляж (RU)' },
        settings_badge_ru_desc: { uk: 'Показать метку открытия российского дубляжа', ru: 'Показать метку международного русского дубляжа', en: 'Показать значок, когда доступна русская дубляж', pl: 'Показать этикетку, где есть русский дубляж' },
        settings_badge_ua_name: { uk: «Украинская озвучка (UA)», ru: «Украинская озвучка (UA)», en: «Украинское аудио (UA)», pl: «Украинский дубляж (UA)» },
        settings_badge_ua_desc: { uk: 'Показать метку обнаружения украинского дубляжа', ru: 'Показать метку Соединенного украинского дубляжа', en: 'Показать значок, когда доступен украинский дубляж', pl: 'Показать этикетку, где есть украинский дубляж' },
        settings_badge_en_name: { uk: 'Английская озвучка (EN)', ru: 'Английская озвучка (EN)', en: 'Английское аудио (EN)', pl: 'Ангельский дубляж (EN)' },
        settings_badge_en_desc: { uk: 'Показать метку открытия английской дороги', ru: 'Показать метку национальной английской дорожки', en: 'Показать значок, когда доступна английская дорожка', pl: 'Показать этики, когда есть ангельская ścieżka' },
        settings_badge_4k_name: { uk: 'Якість 4K', ru: 'Качество 4K', en: '4K качество', pl: 'Jakość 4K' },
        settings_badge_4k_desc: { uk: 'Показать метку наличия 4K отдельного разрешения', ru: 'Показать метку физического разрешения 4K', en: 'Показать значок, когда доступно разрешение 4K', pl: 'Pokazuj etykietę, где доступно 4K' },
        settings_badge_fhd_name: { uk: «Якість FHD», ru: «Качество FHD», en: «Качество FHD», pl: «Якість FHD» },
        settings_badge_fhd_desc: { uk: 'Показать метку наличия Full HD отдельного разрешения', ru: 'Показывать метку разрешения Full HD', en: 'Показывать значок, когда доступен Full HD', pl: 'Показать этикетки, когда доступно только Full HD' },
        settings_badge_hdr_name: { uk: 'HDR / Dolby Vision', ru: 'HDR / Dolby Vision', en: 'HDR / Dolby Vision', pl: 'HDR / Dolby Vision' },
        settings_badge_hdr_desc: { uk: 'Показать метку наличия HDR или Dolby Vision', ru: 'Показать метку национального HDR или Dolby Vision', en: 'Показывать значок, когда доступен HDR или Dolby Vision', pl: 'Показать этикетки, где можно использовать HDR или Dolby Vision' },
        settings_tmdb_input_name: { uk: 'Свій ключ TMDB', ru: 'Свой ключ TMDB', en: 'Пользовательский ключ TMDB', pl: 'Własny klucz TMDB' },
        settings_tmdb_input_placeholder: { uk: «Ключ TMDB (опционально)», ru: «Ключ TMDB (опционально)», en: «Ключ TMDB (необязательно)», pl: «Ключ TMDB (опционально)» },
        settings_tmdb_input_desc: { uk: 'Я вставлю — воспользуйтесь функцией замены ключа Лампы.', ru: 'Если ключ — плагин будет использовать его вместо ключа Лампы.', en: 'Если установлено, плагин будет использовать его вместо ключа Лампы.', pl: 'Если установлено, плагин работает замиаст ключа Лампи.' },
        Menu_title: { uk: 'Меню', ru: 'Меню', en: 'Меню', pl: 'Меню' },
        menu_details: { uk: 'Детальніше', ru: 'Подробнее', en: 'Подробнее', pl: 'Szczegóły' },
        menu_trailer: { uk: 'Трейлер', ru: 'Трейлер', en: 'Trailer', pl: 'Zwiastun' },
        loading_trailer: { uk: 'Загрузка трейлера...', ru: 'Загрузка трейлера...', en: 'Загрузка трейлера...', pl: 'Ładowanie zwiastuna...' },
        kino_settings_title: { uk: 'Киноогляд: Просмотр каналов YouTube', ru: 'Кинообзор: Настройки каналов YouTube', en: 'Обзор фильма: Настройки каналов YouTube', pl: 'Представление фильмов: установка каналов YouTube' },
        kino_add_channel_name: { uk: 'Добавить канал', ru: 'Добавить канал', en: 'Добавить канал', pl: 'Добавить канал' },
        kino_add_channel_desc: { uk: «Посилання YouTube або @ник», ru: «Ссылка YouTube или @ник», en: «Ссылка на YouTube или @handle», pl: «Ссылка на YouTube lub @nazwa» },
        kino_add_channel_input: { uk: 'Посилання на канал або @ник', ru: 'Ссылка на канал или @ник', en: 'Ссылка на канал или @handle', pl: 'Link do kanału lub @nazwa' },
        kino_channel_generic: { uk: «Канал», ru: «Канал», en: «Канал», pl: «Канал» },
        kino_reset_name: { uk: 'Сбросить настройки каналов', ru: 'Сбросить настройки каналов', en: 'Сбросить настройки канала', pl: 'Zresetuj ustawienia kanałów' },
        kino_reset_desc: { uk: 'Очистить список каналов', ru: 'Очистить список каналов', en: 'Очистить список каналов', pl: 'Выбрать список каналов' },
        kino_channel_enabled: { uk: 'Увімкнено', ru: 'Включено', en: 'Включено', pl: 'Włączony' },
        kino_channel_disabled: { uk: 'Вимкнено', ru: 'Выключено', en: 'Disabled', pl: 'Wyłączony' },
        kino_channel_delete_btn: { uk: 'Видалити канал', ru: 'Удалить канал', en: 'Удалить канал', pl: 'Usuń kanał' },
        kino_menu_title: { uk: 'Кіноогляд', ru: 'Кинообзор', en: 'Обзор фильма', pl: 'Przegląd Filmowy' },
        kino_ch_navkolo_kino: {
            Великобритания: «Навколо Кино»,
            ru: 'Вокруг кино',
            en: 'Around Cinema',
            pl: 'Wokół kina'
        },
        kino_ch_serialy_kino: {
            Великобритания: «СЕРІАЛИ и КИННО»,
            ru: 'СЕРИАЛЫ и КИНО',
            en: 'Сериалы и фильмы',
            pl: 'Seriale i kino'
        },
        kino_ch_ekino_ua: {
            Великобритания: 'eKinoUA',
            ru: 'eKinoUA',
            en: 'eKinoUA',
            pl: 'eKinoUA'
        },
        kino_ch_zagin_kinomaniv: {
            Великобритания: «Загин киноманов»,
            ru: 'Отряд киноманов',
            en: 'Отряд киноманов',
            pl: 'Oddział kinomanów'
        },
        kino_ch_moi_dumky: {
            Великобритания: «Мої думки про кино»,
            ru: 'Мои мысли о кино',
            en: 'Мои мысли о кино',
            pl: 'Moje myśli o kinie'
        },
        kino_ch_kino_navuvorit: {
            Великобритания: 'КИНО НАВИВОРИТ',
            ru: 'КИНО НАИЗНАНКУ',
    ...
    var SERVICE_CONFIGS = {
        ...
        'sky_showtime': {
            название: 'Sky Showtime',
            логотип: 'logos/SkyShowtime.svg',
        ...
        'educational_and_reality': {
            заголовок: tr('educational_title'),
            логотип: 'logos/Discovery.svg',
    ...
    /** Для ряда головных каналов: HBO/Prime/Paramount через watch_providers (TMDB), можно выбирать фильмы и сериалы с актуальным контентом. */
    var SERVICE_WATCH_PROVIDERS_FOR_ROW = { hbo: '384', amazon: '119', paramount: '531' };

    // =================================================================
    // Глобальная помощь игрокам
    // =================================================================
            ...
            new YT.Player('yt-player-custom', {
                ...
                события: {
                    'onReady': function(event) {
                        loader.remove(); // Скрыть загрузчик
                        event.target.playVideo();
                    },
                    'onStateChange': function(event) {
                        if (event.data === 0) { // 0 = завершено
                            closePlayer();
                        }
                    },
                    'onError': function(e) {
                        if (e.data == 150 || e.data == 153) Lampa.Noty.show('Видео обмежено власником (Error ' + e.data + ')');
    ...
    // Один элемент героя-рядка (задник+оверлей). heightEm — высота банера (напр. 28).
    function makeHeroResultItem(movie, heightEm) {
        ...
        var renderHeroContent = function(item, movie) {
            item.empty(); // Очистить существующее содержимое
                ...
                function search(searchLang) {
                    ...
                    network.silent(url, function (json) {
                        ...
                        if (trailer && trailer.key) {
                            ...
                            Lampa.Noty.show('Трейлер не известно');
                        }
                    }, function() {
            ...
            network.silent(url, function(details) {
                ...
                // Тип
                вар typeStr = тип === 'фильм'? Lampa.Lang.translate('фильм') : Lampa.Lang.translate('телевидение');
                if (!typeStr || typeStr === 'movie' || typeStr === 'tv') {
                    typeStr = тип === 'фильм'? (lang === 'ru' ? 'Фильм' : 'Фильм') : (lang === 'ru' ? 'Сериал' : 'Серіал');
                }
                ...
                если (возраст) {
                    ...
                    if (!isNaN(ageVal)) {
                        displayAge = ageVal + '+';
                        if (ageVal >= 18) ageColor = '#d32f2f'; // Красный
                        else if (ageVal >= 16) ageColor = '#f57c00'; // Оранжевый
                        else if (ageVal >= 12) ageColor = '#fbc02d'; // Желтый
                        else ageColor = '#388e3c'; // Зеленый
                    } еще {
                        // Сопоставление рейтингов США
                ...
                if (runtime) {
                    ...
                    var m = runtime % 60;
                    вар hStr = час > 0? h + (lang === 'ru' ? 'ч.' : 'год.') : '';
                    вар mStr = м > 0? m + (lang === 'ru' ? 'м.' : 'хв.') : '';
            ...
            параметры: {
                ...
                излучать: {
                    onCreate: function () {
                        ...
                        } catch (e) { console.log('Ошибка onCreate Hero:', e); }
                    },
                    onVisible: function () {
                        пытаться {
                            var item = $(this.html);
                            ...
                            // Остановить загрузку изображения по умолчанию
                            if (this.img) this.img.onerror = function () { };
                            if (this.img) this.img.onload = function () { };
                        } catch (e) { console.log('Ошибка onVisible у героя:', e); }
                    },
                    onlyEnter: function () {
                        // функция запуска трейлера (копируемая логика из кнопки)
                    ...
                    onKey: function(key) {
                        if (key === 'play') {
                           // Копия логики запуска трейлера (можно вынести в отдельную функцию выше, но здесь можно дублировать для обеспечения надежности)
                           var playHeroTrailerKey = function() {
                                ...
                                function search(searchLang) {
                                    ...
                                    network.silent(url, function (json) {
                                        ...
                                        else { Lampa.Noty.show('Трейлер не известно'); }
                                    });
                                }
                                поиск(язык);
                           };
    ...
    function StudiosMain(object) {
        ...
        comp.create = function () {
            ...
            вар сеть = новый Lampa.Reguest();
            var total = categories.length; // Нет раздела "Герой"
            вар статус = новый Lampa.Status(всего);

            status.onComplite = function () {
                var fulldata = [];
                // Раздел «Герой» удален — отображаются только категории
                if (status.data) {
            ...
            // Раздел «Герой» удален — загружаются только категории
            categories.forEach(function (cat, index) {
                ...
                network.silent(url, function (json) {
                    ...
                    // ИСПРАВЛЕНИЕ: Нормализация путей к изображениям
    ...
    // Категория секций «Украинская стрічка» — фильмы/сериалы/шоу украинского творчества (TMDB)
    // Жанри ТВ: Реальность 10764, Разговор 10767
    ...
    function UkrainianFeedMain(object) {
        ...
        comp.create = function () {
            ...
            requestIndices.forEach(function (catIndex, rIdx) {
                ...
                var url = Lampa.TMDB.api(cat.url + '?' + params.join('&'));
                network.silent(url, function (json) {
                    // ИСПРАВЛЕНИЕ: Нормализация путей к изображениям для всех элементов
                    if (json && json.results && Array.isArray(json.results)) {
                        json.results.forEach(function (item) {
                            if (!item.poster_path && item.backdrop_path) {
                                item.poster_path = item.backdrop_path;
    ...
    // Категория сек для «Польская стрічка» — фильмы/сериалы/шоу польского творчества (TMDB)
    ...
    // Категория сек для «Российская стрічка» — фильмы/сериалы/шоу российской мовою (TMDB)
    ...
    function StudiosView(object) {
        ...
        comp.create = function () {
            ...
            network.silent(buildUrl(1), function (json) {
                // ИСПРАВЛЕНИЕ: Убедитесь, что для отображения всех элементов указан poster_path.
                // Если backdrop_path существует, но poster_path отсутствует, используйте backdrop_path
                if (json && json.results && Array.isArray(json.results)) {
                    json.results.forEach(function (item) {
                        if (!item.poster_path && item.backdrop_path) {
                            item.poster_path = item.backdrop_path;
    ...
    // =================================================================
    // ПІДПИСКИ НА СТУДИИ (Ліхтар — интегрировано со studio_subscription)
    // =================================================================
    var FlixioStudioSubscription = (function () {
        ...
        function add(company) {
            ...
            if (!studios.find(function (s) { return String(s.id) === String(c.id); })) {
                studios.push(c);
                setParams(studios);
                Lampa.Noty.show(Lampa.Lang.translate('title_bookmarked') || 'Додано в подписки');
            }
        }

        функция remove(company) {
            var studios = getParams();
        ...
        function injectButton(object) {
            ...
            var interval = setInterval(function () {
                ...
                if (!nameEl.length || !company || !company.id) {
                    попытки++;
                    Если количество попыток > 25, то clearInterval(interval);
                    возвращаться;
                }
                ...
                function updateState() {
                    ...
                    btn.text(sub ? 'Выписать' : 'Підписаться');
                ...
                // Автоматически фокусирует кнопку подписки, чтобы она сразу же стала видимой
                setTimeout(function () {
                    пытаться {
        ...
        возвращаться {
            инициализация: функция () {
                вар существующий = Lampa.Storage.get(storageKey, '[]');
    ...
    function removeShotsSection() {
        ...
        // Возвращаясь к реальности, вы можете увеличить количество выстрелов
        setTimeout(doRemove, 1000);
        setTimeout(doRemove, 3000);
        setTimeout(doRemove, 6000);
    }

    // ========== РЯД 1: HERO SLIDER (Новинки) ==========
    function addHeroRow() {
        Lampa.ContentRows.add({
            индекс: 0,
            имя: 'custom_hero_row',
            заголовок: tr('hero_row_title'),
            экран: ['главный'],
            вызов: функция (параметры) {
                return function (callback) {
                    вар сеть = новый Lampa.Reguest();
                    // Загрузить фильмы, которые сейчас идут в прокате (новинки)
                    var url = Lampa.TMDB.api('movie/now_playing?api_key=' + getTmdbKey() + '&language=' + Lampa.Storage.get('language', 'uk') + '®ion=UA');

                    network.silent(url, function (json) {
                        var items = json.results || [];
                        if (!items.length) {
                            // Резервный вариант, если нет новых фильмов
    ...
    var studios = [
        ...
        // Пересылка нового контента за оставшиеся 7 дней
        ...
        Lampa.ContentRows.add({
            индекс: 1, // После Героя (0)
            имя: 'custom_studio_row',
            заголовок: tr('streamings_row_title'),
            экран: ['главный'],
            вызов: функция (параметры) {
                return function (callback) {
                    var items = studios.map(function (s) {
                        var isUkrainianFeed = s.isUkrainianFeed === true;
                        вар isPolishFeed = s.isPolishFeed === true;
                                ...
                                излучать: {
                                    ...
                                    onCreate: function () {
                                        ...
                                        if (isUkrainianFeed) {
                                            ...
                                            var обертка = $('<div class="studio-logo-wrap"></div>');
                                            
                                            // используем SVG, если есть, иначе резервный текст
                                            if (s.svg) {
                                                var svgEl = $(s.svg);
    ...
    // ========== РЯД: НОВИНКИ РОСІЙСЬКОЇ СТРІЧКИ ==========
    function addRussianContentRow() {
        Lampa.ContentRows.add({
            индекс: 3, // Герой(0), Студии(1), Настроение(2), затем Русский(3)
            имя: 'russian_content_row',
    ...
    // ========== РЯД: НОВИНКИ УКРАЇНСЬКОЇ СТРІЧКИ ==========
    function addUkrainianContentRow() {
        Lampa.ContentRows.add({
            индекс: 4, // после русского(3)
            имя: 'ukrainian_content_row',
    ...
    // ========== РЯД: НОВИНКИ АНГЛОМОВНОЙ СТРИЧКИ ==========
    function addEnglishContentRow() {
        Lampa.ContentRows.add({
            индекс: 5, // после украинского(4)
            имя: 'english_content_row',
    ...
    // ========== РЯД: НОВИНКИ ПОЛЬСЬКОЇ СТРИЧКИ ==========
    // (переиндексация для нового порядка RU-UA-EN-PL)
    // Жанри TMDB: Драма 18, Комедия 35, Мультфильм 16, Сімейний 10751, Документальный 99, Бойовик 28, Мелодрама 10749, Трилер 53, Криминал 80, Пригоди 12, Жахи 27, Фентезі 14
    function addMoodRow() {
        var moods = [
            ...
            Lampa.ContentRows.add({
                индекс: 2, // Сразу после потоков (1)
                имя: 'custom_mood_row',
                заголовок: tr('mood_row_title'),
            экран: ['главный'],
            вызов: функция (параметры) {
                return function (callback) {
                    вар сеть = новый Lampa.Reguest();
    ...
    function addStyles() {
        ...
        $('body').append(`
            <style id="custom_main_page_css">
                /* Баннер героя (‑20%: 22em) */
                .card.hero-banner {
                    ширина: 52vw !важно;
                    высота: 25em !важно;
                    margin: 0 1.5em 0.3em 0 !important; /* Уменьшенное нижнее поле */
                    display: inline-block;
                    scroll-snap-align: start; /* Smart Snap */
                    scroll-margin-left: 1.5em !important; /* Принудительный отступ для каждой карточки */
                }
                
                /* Снимок контейнера (резервный вариант) */
                ...
                /* Глобальное уменьшение межстрочного расстояния */
                .row--card {
                     margin-bottom: -1.2em !important; /* Сдвинуть строки ближе примерно на 40% */
                }
                ...
                .flixio-more-btn {
                    ...
                    justify-content: center;
                    курсор: указатель;
                    Переход: трансформация 0,2 с, фон 0,2 с;
                    /* Запрещенное правило - вперед! */
                    заказ: 9999 !важно;
                }
                ...
                /* Скрывает значки качества из click_theme.js, если активирован studio5.js */
                .click-quality,
                .click-quality-full,
    ...
    function initMarksJacRed() {
        ...
        function fetchWithProxy(url, callback) {
            // Спочатку пробуємо Lampa.Reguest (вбудования проксі Лампи)
            пытаться {
                вар сеть = новый Lampa.Reguest();
                network.timeout(10000);
                network.silent(url, function (json) {
                    console.log('[JacRed] Прямой успех через Lampa.Reguest');
        ...
        function tryProxies(url, callback) {
            ...
            function tryProxy(index) {
                if (index >= proxyList.length) {
                    console.error('[JacRed] Все прокси не работают для:', url);
                    callback(new Error('Прокси не сработал'));
                    возвращаться;
                }
                var p = proxyList[index];
                var target = p.indexOf('url=') > -1 ? p + encodeURIComponent(url) : p + url;
                console.log('[JacRed] Получение данных через прокси:', target);
                ...
                xhr.onerror = function () {
                    console.warn('[JacRed] Ошибка прокси:', p);
                    tryProxy(index + 1);
                };
                xhr.timeout = 10000;
        ...
        function getBestJacred(card, callback) {
            // новая версия кэша, для пересчета языковых меток по обновлённым правилам
            вар кэшКей = 'jacred_v4_' + card.id;

            // Кэш в памяти (миттєвий)
            ...
            // кэш localStorage (переживаемое перезавантаження)
            пытаться {
            ...
            if (releaseDate && releaseDate.getTime() > Date.now()) {
                console.warn('[JacRed] ПРОПУСК: будущий релиз');
                callback(null);
                возвращаться;
            }
            ...
            fetchWithProxy(apiUrl, function (err, data) {
                ...
                пытаться {
                    ...
                    пытаться {
                        ...
                        console.error('[JacRed] Ошибка синтаксического анализа JSON:', e);
                        console.log('[JacRed] Исходные данные:', data);
                        callback(null);
                        возвращаться;
                    }

                    // Обработка обертки AllOrigins, если она присутствует
                    if (parsed.contents) {
                        пытаться {
                            parsed = JSON.parse(parsed.contents);
                        } catch (e) {
                            console.log('[JacRed] Не удалось разобрать внутреннее содержимое, используется необработанный текст');
                        }
                    }

                    var results = Array.isArray(parsed) ? parsed : (parsed.Results || []);
                    console.log('[JacRed] Результаты обработки:', results.length);
                    ...
                    var best = { разрешение: 'SD', рус: false, укр: false, англ: false, hdr: false };
                    ...
                    results.forEach(function (item) {
                        ...
                        // 1) Пытаемся определить качество по числовому полю JacRed (качество)
                        var currentRes = 'SD';
                        ...
                        // 2) Если качество отсутствует или равно 0 — запасной вариант по названию
                        if (currentRes === 'SD') {
                        ...
                        // RU аудиомаркеры — максимально широкий набор паттернов
                        если (
                            t.indexOf('rus') >= 0 ||
                            t.indexOf('russian') >= 0 ||
                            t.indexOf('рус') >= 0 ||
                        ...
                        // JacRed дополнительно отдает массив голосов и трекера.
                        // Для русских трекеров считаем любую озвучку в голосах как RU.
                        if (!best.rus) {
                            var ruTrackers = ['кинозал', 'rutracker', 'rutor', 'nnmclub', 'megapeer', 'selezen'];
                        ...
                        // HDR/Dolby Vision: сначала по типу видео, затем по названию
                    ...
                    console.log('[JacRed] РЕЗУЛЬТАТ для', card.id, ':', JSON.stringify(best));
                    callback(best);
        ...
        // Вставить метки в новую карту (полная логика для поделок и даже открытых страниц)
        function injectFullCardMarks(movie, renderEl) {
            // Информация о сезонах теперь добавляется через fillInfo
            возвращаться;
        }

        // ====== Функции для работы с электричеством ======
        var studios_quality_cache_key = 'studios_quality_cache';
        вар studios_quality_cache_ttl = 12 * 60 * 60 * 1000; // 12 часов
        ...
        function studiosNormalizeCardForQuality(data) {
            ...
            возвращаться {
                ...
                заголовок: данные && (data.title || data.name || '') || '',
        ...
        function studiosEstimateFallbackQuality(normalized, originalData) {
            ...
            if (normalized && normalized.release_date && normalized.release_date.length >= 4) {
                год = parseInt(normalized.release_date.substring(0, 4), 10);
        ...
        function studiosResolveRealQuality(cardData, callback) {
            пытаться {
                console.log('[Studios5] Начало проверки качества для:', cardData.title || cardData.name);
                
                // Проверяем, включаем ли парсер
                var parserEnabled = Lampa.Storage.get('parser_use', false);
                console.log('[Studios5] Парсер включен:', parserEnabled);
                
                if (!parserEnabled) {
                    console.log('[Studios5] Парсер отключен, используется резервный вариант по году');
                    // Если парсер выключен, используйте резервный вариант по году
                ...
                if (!Lampa.Parser || typeof Lampa.Parser.get !== 'function') {
                    console.log('[Studios5] Lampa.Parser недоступен, используется резервный вариант по году');
                    var normalized = studiosNormalizeCardForQuality(cardData);
                    var estimated = studiosEstimateFallbackQuality(normalized, cardData);
                    callback(estimated || null);
                    возвращаться;
                ...
                }[Lampa.Storage.get('parse_lang', 'ru')] || данные карты.заголовок;
                
                console.log('[Studios5] Поиск с помощью запроса:', searchQuery);
                ...
                Lampa.Parser.get({
                    ...
                    console.log('[Studios5] Ответ парсера:', data);
                    
                    if (!data || !data.Results || data.Results.length === 0) {
                        console.log('[Studios5] Нет результатов от парсера, используется резервный год');
                        var normalized = studiosNormalizeCardForQuality(cardData);
                        var estimated = studiosEstimateFallbackQuality(normalized, cardData);
                        callback(estimated || null);
                        возвращаться;
                    ...
                    console.log('[Studios5] Обработка', data.Results.length, 'results');
                    
                    data.Results.forEach(function(result) {
                        if (result.ffprobe && Array.isArray(result.ffprobe)) {
                            вар videoInfo = функция (ffprobeData) {
                                if (!ffprobeData || !Array.isArray(ffprobeData)) возвращает ноль;
                                ...
                                if (videoTrack) {
                                    ...
                                    if (videoTrack.side_data_list) {
                                        ...
                                        var hasContentLight = videoTrack.side_data_list.some(function(item) {
                                            return item.side_data_type === 'Метаданные уровня доступности контента';
                                        });
                                        
                                        if (videoTrack.side_data_list.some(function(item) {
                                            return item.side_data_type === 'Запись конфигурации DOVI' || item.side_data_type === 'Dolby Vision RPU';
                                        })) {
                    ...
                    console.log('[Studios5] Аудио найдено:', Array.from(audio));
                    ...
                    console.log('[Studios5] Итоговый результат качества:', result.quality);
                    
                    if (result.quality) {
                        callback({ code: result.quality, label: result.quality, fromParser: true });
                    } еще {
                        console.log('[Studios5] Нет качества от парсера, используется резервный год');
                        // Резервный вариант к оценке по году
                        var normalized = studiosNormalizeCardForQuality(cardData);
                        var estimated = studiosEstimateFallbackQuality(normalized, cardData);
                        callback(estimated || null);
                    }
        ...
        // ====== Принудительное применение стилей к бейджам качествам ======
        function forceQualityBadgeStyles() {
            $('.card__badge--quality').each(function() {
                // Пропускаем герои-баннеры (Новинки проката)
        ...
        // Безопасная функция проверки настроек
        функция isBadgeEnabled(badgeName) {
            пытаться {
                if (typeof Lampa !== 'undefined' && Lampa.Storage && typeof Lampa.Storage.get === 'function') {
                    return Lampa.Storage.get(badgeName, true);
                }
                вернуть истину; // По умолчанию включено
            } catch (e) {
                console.log('[Studios5] Ошибка проверки настроек значка:', badgeName, e);
                вернуть истину; // Когда нужны деньги включаем
            }
        }
        ...
        function addBadges(cardEl, movie) {
            ...
            // Проверяем, не является ли это героем-баннером (Новинки проката)
            if ($(cardEl).hasClass('hero-banner')) {
                console.log('[Studios5] Пропуск значков для баннера героя (Новинки проката)');
                возвращаться;
            }
            ...
            // S1 (Сезон) — левый верхний угол (только один бейдж в эфире)
            ...
            if (isTvSeries && isBadgeEnabled('flixio_badge_seasons')) {
                вар SeasonNumber = 1; // По умолчанию S1
                ...
                function updateSeasonBadge(seasonNum, currentEpisode, totalEpisodes) {
                    var badgeText;
                    вар isComplete = totalEpisodes > 0 && currentEpisode >= totalEpisodes;
                ...
                if (lastEpisode && lastEpisode.season_number && seasons && Array.isArray(seasons)) {
                    ...
                    for (var i = 0; i < seasons.length; i++) {
                        if (seasons[i].season_number === lastEpisode.season_number) {
                            ...
                            вар currentEpisode = LastEpisode.episode_number || 1;
            ...
            if (movie.release_date && movie.release_date.length >= 4) {
                год = movie.release_date.substring(0, 4);
            } else if (movie.first_air_date && movie.first_air_date.length >= 4) {
                год = movie.first_air_date.substring(0, 4);
            } else if (movie.year) {
            ...
            // Всегда вызываем качество как минимум
            ...
            if (estimated && estimated.label && isBadgeEnabled('flixio_badge_quality')) {
                ...
                if (shortLabel) {
                    ...
                    console.log('[Studios5] Добавлен значок качества, основанный на годе:', shortLabel);
                }
            }
            
            // Пытаемся получить более точное качество от парсера (если доступно)
            studiosResolveRealQuality(movie, function(result) {
                console.log('[Studios5] Результат оценки качества парсера для фильма:', movie.title || movie.name, result);
                
                if (!result || !result.label) {
                    console.log('[Studios5] Нет данных о качестве парсера, сохраняем данные по годам');
                    возвращаться;
                }
                
                if (!view || !view.isConnected) {
                    console.log('[Studios5] Элемент представления не подключен');
                    возвращаться;
                }
                ...
                // Определяем короткую метку качества для форм от парсера
                if (lower.includes('8k')) {
                    ...
                    shortLabel = 'SD';
                } else if (lower.includes('camrip') || lower.includes('camrip')) {
                    shortLabel = 'CAM';
                    ...
                    // Для других форм оставляем как есть или компромиссем
                ...
                if (!shortLabel) {
                    console.log('[Studios5] Не создана короткая метка для:', result.label);
                    возвращаться;
                }
                
                // Заменяем существующие бейдж-качества на более надежные
                ...
                if (existingBadge.length > 0) {
                    ...
                    console.log('[Studios5] Значок качества обновлен до:', shortLabel, 'из парсера:', result.fromParser);
                } еще {
                    varqualityBadge = $('<div>', {
                        class: 'card__badge card__badge--custom card__badge--quality',
                        текст: shortLabel,
                    ...
                    view.append(qualityBadge);
                    console.log('[Studios5] Добавлен значок качества парсера:', shortLabel);
                }
            });
        ...
        // ——— Повна карта: подія 'full' + обработка также открытї (глубокая ссылка ?card=...) ———
        function initFullCardMarks() {
            if (!Lampa.Listener || !Lampa.Listener.follow) return;
            Lampa.Listener.follow('full', function (e) {
                if (e.type !== 'complite') return;

                // Очистка документов click_theme.js (черные значки качества)
                var attempts = 0;
                var cleaner = setInterval(function() {
                     ...
                     попытки++;
                     if (attempts > 25) clearInterval(cleaner); // 5 seconds
                }, 200);
            ...
            // Что выделили по силе ?card=..., одна карта также до этого инициализации — обработать ее одразу
            setTimeout(function () {
                пытаться {
                    ...
                    // Очистка артефактов click_theme.js (для прямых ссылок)
                    var attempts = 0;
                    var cleaner = setInterval(function() {
                         var badges = document.querySelectorAll('.click-quality, .click-quality-full, .full-start__status.click-quality-full');
                         for (var i = 0; i < badges.length; i++) badges[i].remove();
        ...
        // Карты на головном: MutationObserver файлы для .card (повторно карту обрабатываем через полную подставку)
        function processCards() {
            ...
            $('.card:not(.jacred-mark-processed-v2)').each(function () {
                ...
                if (card.hasClass('hero-banner')) {
                    console.log('[Studios5] Пропуск обработки главного баннера (Новинки проката)');
                    возвращаться;
                }

                // Герои-баннеры извлекают фильм в HeroMovieData
        ...
        function renderInfoRowBadges(container, data) {
            ...
            if (data.resolution && data.resolution !== 'SD') {
                вар resText = data.разрешение;
                if (resText === 'FHD') resText = '1080p';
                else if (resText === 'HD') resText = '720p';

                varqualityTag = $('<div class="full-start__pg"></div>');
        ...
        function addMarksToContainer(element, movie, viewSelector) {
            ...
            getBestJacred(movie, function (data) {
                ...
                // Даже если JacRed ничего не вернулось (пусто),
                // всё равно отрисуем рейтинг, если у него есть карточки
        ...
        style.innerHTML = `
            /* ====== Вирівнюємо родное тв мітку с нами ====== */
            .card .card__type {
                слева: -0.2em !важно;
            }

            /* ====== Знаки карты — зло, совместитель під ТВ ====== */
            .card-marks {
                положение: абсолютное;
                top: 2.2em;
                слева: -0.2em;
            ...
            /* Единый просмотр для всех типов карт (Фильм/Сериал) */
            ...
            .card__mark {
                ...
                непрозрачность: 0;
                анимация: метка-появление 0,35 с плавное отступление вперед;
            ...
            .card__badge--custom {
                ...
                цвет: #fff;
                непрозрачность: 0;
                анимация: плавное появление значка 0,3 с, плавное исчезновение вперед;
            ...
            /* ====== Картка "На сток стрімінгу" — використовуємо нативный card-more ====== */
            .service-more-card .card-more__box {
                высота: 0;
                Наполнитель снизу: 150%;
                положение: относительное;
            }
            ...
            /* Скрывает все кастомные бейджи на героях-баннерах (Новинки проката) */
            .hero-banner .card__badge--custom {
                display: none !important;
            }
            
            /* ====== Отметки полной карты (информационная строка) ====== */
            ...
            Lampa.ContentRows.add({
                ...
                вызов: функция (параметры) {
                    return function (callback) {
                        ...
                        var apiKey = 'api_key=' + getTmdbKey() + '&language=' + Lampa.Storage.get('language', 'uk');
                        var voiceQ = '&vote_count.gte=' + minVotes;

                        // Время свежести: сегодня и 8 месяцев назад
                        var d = new Date();
                        var currentDate = [d.getFullYear(), ('0' + (d.getMonth() + 1)).slice(-2), ('0' + d.getDate()).slice(-2)].join('-');
                        var past = new Date();
                        ...
                        // Фильмы: любим свежесть, но сортируем ПО ПОПУЛЯРНОСТИ!
                        if (companyQ || genreQ) {
                        ...
                        // Сериалы: радуемся свежести, но сортируем ПО ПОПУЛЯРНОСТИ!
                        ...
                        requests.forEach(function (req) {
                            req(function (items) {
                                ...
                                если (pending === 0) {
                                    ...
                                    // Финальная сортировка: независимо от популярности
    ...
    // ========== РЯД: НОВИНКИ ПОЛЬСКИЕ СТРИЧКИ (в кінці головной) ==========
    function addPolishContentRow() {
        Lampa.ContentRows.add({
            индекс: 6, // после английского(5)
            имя: 'polish_content_row',
    ...
    function modifyServiceTitles() {
        ...
        вар таймер = setInterval (функция () {
            ...
            // То же самое для Украинской, Польской и Росийской строчек
            $('.items-line').each(function () {
                var line = $(this);
                ...
                var isUA = titleText.indexOf('українская стрічки') !== -1;
                var isPL = titleText.indexOf('польская стрічки') !== -1;
                var isRU = titleText.indexOf('російская стрічки') !== -1;
                if (!isUA && !isPL && !isRU) return;

                вар dataKey = isUA? 'flixio-more-ua': (isPL? 'flixio-more-pl': 'flixio-more-ru');
                ...
                вар цвет = isUA? '#ffd700': (isPL ? '#c41e3a': '#d52b1e');
    ...
    function overrideApi() {
        // При необходимости сделайте резервную копию оригинала, но мы хотим его заменить.
        var originalMain = Lampa.Api.sources.tmdb.main;

        Lampa.Api.sources.tmdb.main = function (params, oncomplite, onerror) {
            var parts_data = [];

            // Разрешить плагинам (таким как наш) добавлять свои строки
            Lampa.ContentRows.call('main', params, parts_data);

            // Теперь в parts_data содержатся ТОЛЬКО пользовательские строки (поскольку мы не добавили стандартные).

            // Для обработки этих строк используйте стандартный загрузчик.
    ...
    функция setupSettings() {
        if (!Lampa.SettingsApi || !Lampa.SettingsApi.addComponent) return;

        // Создаём единую вкладку "Ліхтар"
        Lampa.SettingsApi.addComponent({
            компонент: 'flixio_plugin',
            имя: tr('settings_tab_title'),
        ...
        Lampa.SettingsApi.addParam({
            ...
            поле: { имя: tr('settings_tmdb_input_name'), описание: tr('settings_tmdb_input_desc') }
        });

        // === Секция: Секция головная ===
        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            параметр: { тип: 'title' },
            поле: { имя: tr('settings_sections_title') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_row_hero', type: 'trigger', default: true },
            поле: { имя: tr('settings_hero_name'), описание: tr('settings_hero_desc') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_section_streamings', type: 'trigger', default: true },
            поле: { имя: tr('settings_streamings_name'), описание: tr('settings_streamings_desc') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_section_mood', type: 'trigger', default: true },
            поле: { имя: tr('settings_mood_name'), описание: tr('settings_mood_desc') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_row_ru_feed', type: 'trigger', default: false },
            поле: { имя: tr('settings_row_ru_name'), описание: tr('settings_row_ru_desc') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_row_ua_feed', type: 'trigger', default: false },
            поле: { имя: tr('settings_row_ua_name'), описание: tr('settings_row_ua_desc') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_row_en_feed', type: 'trigger', default: false },
            поле: { имя: tr('settings_row_en_name'), описание: tr('settings_row_en_desc') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_row_pl_feed', type: 'trigger', default: false },
            поле: { имя: tr('settings_row_pl_name'), описание: tr('settings_row_pl_desc') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_row_today_netflix', type: 'trigger', default: true },
            поле: { имя: tr('settings_today_netflix_name'), описание: tr('settings_today_netflix_desc') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_row_today_apple', type: 'trigger', default: true },
            поле: { имя: tr('settings_today_apple_name'), описание: tr('settings_today_apple_desc') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_row_today_hbo', type: 'trigger', default: true },
            поле: { имя: tr('settings_today_hbo_name'), описание: tr('settings_today_hbo_desc') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_row_today_prime', type: 'trigger', default: true },
            поле: { имя: tr('settings_today_prime_name'), описание: tr('settings_today_prime_desc') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_row_today_disney', type: 'trigger', default: true },
            поле: { имя: tr('settings_today_disney_name'), описание: tr('settings_today_disney_desc') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            параметр: { имя: 'flixio_row_today_paramount', тип: 'trigger', по умолчанию: true },
            поле: { имя: tr('settings_today_paramount_name'), описание: tr('settings_today_paramount_desc') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_row_today_sky', type: 'trigger', default: true },
            поле: { имя: tr('settings_today_sky_name'), описание: tr('settings_today_sky_desc') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_row_today_hulu', type: 'trigger', default: true },
            поле: { имя: tr('settings_today_hulu_name'), описание: tr('settings_today_hulu_desc') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            параметр: { тип: 'title' },
            поле: { имя: tr('settings_badges_title') }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_badge_seasons', type: 'trigger', default: true },
            поле: { name: 'Сезоны', описание: 'Показать значок для сезонов на карточках' }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_badge_year', type: 'trigger', default: true },
            поле: { name: 'Год', описание: 'Показывать значок на год на карточках' }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_badge_quality', type: 'trigger', default: true },
            поле: { name: 'Качество', описание: 'Показывать значок качества на карточках' }
        });

        Lampa.SettingsApi.addParam({
            компонент: 'flixio_plugin',
            param: { name: 'flixio_badge_rating', type: 'trigger', default: true },
            поле: { name: 'Рейтинг', описание: 'Показывать значок для рейтинга на карточках' }
        });
    }
    ...
    function initApplecationFullCard() {
        ...
        if (!document.getElementById('flixio_applecation_css')) {
            var style = document.createElement('style');
            style.id = 'flixio_applection_css';
            style.textContent =
                '.applection{transition:all .3s}' +
        ...
        function ensureOverlayTemplate() {
            ...
            Lampa.Template.add('applection_overlay',
        ...
        function injectApplectionDom(activity) {
            вар рендер = Activity.render();
            render.addClass('applection');
            ...
            if (rateLine.length) {
                ...
                if (metaNode.length) rateLine.insertAft(metaNode);
            }
        ...
        function getTypeLabel(movie) {
            ...
            var isTv = !!movie.name;
            var map = {
                ру: isTv ? 'Сериал': 'Фильм',
                ru: isTv ? «Телесериал»: «Кино»,
                Великобритания: isTv? 'Сериал': 'Фильм',
                быть: isTv ? 'Серый' : 'Фильм',
                БГ: это ТВ? «Сериал»: «Фильм»,
                cs: isTv? «Сериал»: «Фильм»,
                он: это ТВ? 'סדרה': 'סרט',
                пт: isTv ? «Сериал»: «Фильм»,
                ж: это ТВ? '电视剧': '电影'
            };
        ...
        function pluralSeasons(count {
            ...
            if (['ru', 'uk', 'be', 'bg'].indexOf(lang) !== -1) {
                ...
                var a = {
                    ...
                    Великобритания: ['сезон', 'сезоны', 'сезонов'],
                    быть: ['сезон', 'сезоны', 'сезонаў'],
                    bg: ['сезон', 'сезона', 'сезона']
                };
                var form = (a[lang] || a.ru);
            ...
            if (lang === 'he') return count === 1 ? 'עונה' + количество: количество + 'עונות';
            if (lang === 'zh') return count + ' 季';
            var key = Lampa.Lang.translate('full_ Season');
        ...
        function injectDescription(activity, movie) {
            ...
            render.find('.applection__description').text(text);
            ...
            var countries = (movie.production_countries ? movie.production_countries.map(function (c) {
                ...
                вар т = Lampa.Lang.translate(ключ);
        ...
        function injectInfo(activity, movie) {
            вар рендер = Activity.render();
            var info = render.find('.applection__info');
        ...
        function getQualityLabels(movie, activity) {
            ...
            var title = movie.title || название фильма || «Неизвестно»;
                    ...
                    if (item.ffprobe && Array.isArray(item.ffprobe)) {
                        ...
                        если (видео) {
                            ...
                            if (video.side_data_list) {
                                ...
                                var hasCl = video.side_data_list.some(function (x) { return x.side_data_type === 'Метаданные уровня доступности контента'; });
                                var hasDv = video.side_data_list.some(function (x) { return x.side_data_type === 'Запись конфигурации DOVI' || x.side_data_type === 'Dolby Vision RPU'; });
                                if (hasDv) {
        ...
        function loadLogo(activity, movie) {
            ...
            $.get(url, function (data) {
                ...
                if (data && data.logos && data.logos[0]) {
                    ...
                    вар imgUrl = Lampa.TMDB.image('/t/p/w500' + p);
                    var img = new Image();
                    img.onload = function () {
                        if (!isComponentActive(activity)) return;
        ...
        Lampa.Listener.follow('full', function (e) {
            ...
            waitForBackground(activity, function () {
                if (!isComponentActive(activity)) return;
                render.find('.applection__meta').addClass('show');
                render.find('.applecation__description-wrapper').addClass('show');
                render.find('.applection__info').addClass('show');
    ...
    function initMaxsmRatingsIntegration() {
        ...
        var C_LOGGING = false;
        вар CACHE_TIME = 3 * 24 * 60 * 60 * 1000;

        var OMDB_CACHE = 'maxsm_ratings_omdb_cache';
        вар KP_CACHE = 'maxsm_ratings_kp_cache';
        ...
        var imdb_svg = '<?xml version="1.0" encoding="utf-8"?><svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 122.88" xml:space="preserve"><style type="text/css"><![CDATA[.st0{fill:#F5C518;}]]></style><g><path class="st0" d="M18.43,0h86.02c10.18,0,18.43,8.25,18.43,18.43v86.02c0,10.18-8.25,18.43-18.43,18.43H18.43 C8.25,122.88,0,114.63,0,104.45l0-86.02C0,8.25,8.25,0,18.43,0L18.43,0z"/><path d="M24.96,78.72V44.16h-9.6v34.56H24.96L24.96,78.72z M45.36,44.16L43.2,60.24L42,51.6l-1.2-7.44l-12,0v34.56h8.16v-22.8 л3.36,22.8х6л3.12-23.28в23.28х8.16В44.16Х45.36Л45.36,44.16з М61.44,78.72В44.16х14.88с3.6,0,6.24,2.64,6.24,6в22.56 с0,3,36-2,64,6-6,24,6H61.44L61.44,78.72z М72.72,50.4л-2,16-0,24в22,56с1.2,0,2,16-0,24,2,4-0,72с0,48-0,48,0,48-1,92,0,48-4,32 В54.24в-2.88Л72.72,50.4Л72.72,50.4Л72.72,50.4з М100.56,52.8х0.72с3.36,0,6.24,2.64,6.24,6в13.92с0,3.36-2.88,6-6.24,6л-0.72,0 в-1.92,0-3.84-0.96-5.04-2.64л-0.48,2.16Х86.4В44.16х9.12В55.2С96.72,53.76,98.64,52.8,100.56,52.8L100.56,52.8з М98.64,69.6в-8.16 L98.4,58.8c-0.24-0.48-0.96-0.72-1.44-0.72c-0.48,0-1.2,0.24-1.44,0.72v13.68c0.24,0.48,0.96,0.72,1.44,0.72 c0.48,0,1.44-0.24,1.44-0.72L98.64,69.6L98.64,69.6z"/></g></svg>';
        ...
        if (Lampa.Lang && Lampa.Lang.add) {
            Lampa.Lang.add({
                maxsm_ratings: { ru: «Рейтинг и качество», en: «Рейтинг и качество», uk: «Рейтинг і якість», pl: «Оцена и качество» },
                maxsm_ratings_cc: { ru: 'Очистить локальный кеш', en: 'Очистить локальный кеш', uk: 'Очистить локальный кеш', pl: 'Выполнить локальный кеш' },
                maxsm_ratings_critic: { ru: «Оценки критиков», en: «Рейтинги критиков», uk: «Оценки критиков», pl: «Оценки критиков» },
                maxsm_ratings_mode: { ru: 'Средний рейтинг', en: 'Средний рейтинг', uk: 'Средний рейтинг', pl: 'Средняя оценка' },
                maxsm_ratings_mode_normal : { ru: 'Показать средний рейтинг', en: 'Показать средний рейтинг', uk: 'Показать средний рейтинг', pl: 'Показать средний рейтинг' },
                maxsm_ratings_mode_simple: { ru: 'Только средний рейтинг', en: 'Только средний рейтинг', uk: 'Лише среднего рейтинга', pl: 'Только средний рейтинг' },
                maxsm_ratings_mode_noavg: { ru: 'Без среднего рейтинга', en: 'Нет среднего', uk: 'Без среднего рейтинга', pl: 'Без среднего' },
                maxsm_ratings_icons: { ru: 'Значки', en: 'Icony', uk: 'Значки', pl: 'Ikony' },
                maxsm_ratings_colors: { ru: «Цвета», en: «Цвета», uk: «Колори», pl: «Kolory» },
                maxsm_ratings_avg: { ru: 'ИТОГ', en: 'TOTAL', uk: 'ПІДСУМОК', pl: 'RAZEM' },
                maxsm_ratings_avg_simple: { ru: «Оценка», en: «Рейтинг», uk: «Оценка», pl: «Оцена» },
                ...
                maxsm_ratings_emmy: { ru: «Эмми», en: «Эмми», uk: «Еммі», pl: «Эмми» },
                maxsm_ratings_awards: { ru: «Награды», en: «Награды», uk: «Нагороди», pl: «Нагроды» },
                maxsm_ratings_show_total: { ru: 'Итог', en: 'Total', uk: 'Підсумок', pl: 'Разем' },
                maxsm_ratings_show_oscars: { ru: 'Оскар', en: 'Oscar', uk: 'Оскар', pl: 'Oscar' },
                maxsm_ratings_show_awards: { ru: «Награды», en: «Награды», uk: «Нагороди», pl: «Нагроды» },
                maxsm_ratings_show_tmdb: { ru: 'TMDB', en: 'TMDB', uk: 'TMDB', pl: 'TMDB' },
                maxsm_ratings_show_imdb: { ru: 'IMDB', en: 'IMDb', uk: 'IMDb', pl: 'IMDb' },
                maxsm_ratings_show_kp: { ru: 'Кинопоиск', en: 'Кинопоиск', uk: 'Кинопошук', pl: 'Кинопоиск' },
                maxsm_ratings_show_rt: { ru: 'Помидоры', en: 'Помидоры', uk: 'Помидоры', pl: 'Помидоры' },
                maxsm_ratings_show_mc: { ru: 'Metacritic', en: 'Metacritic', uk: 'Metacritic', pl: 'Metacritic' },
                maxsm_ratings_quality: { ru: 'Качество внутри карточек', en: 'Качество внутри карточек', uk: 'Якість всередини карточек', pl: 'Jakość w kartach' },
                maxsm_ratings_quality_inlist: { ru: «Качество на карточках», en: «Качество на картах», uk: «Якість на картах», pl: «Якосц на картах» },
                maxsm_ratings_quality_tv: { ru: «Качество для сериалов», en: «Качество для сериалов», uk: «Якість для сериалов», pl: «Якоть для сериалов» }
            });
        }
        ...
        function parseAwards(awardsText) {
            ...
            var oscarMatch = awardsText.match("Выиграл(-d+) Оскары?");
            if (oscarMatch && oscarMatch[1]) result.oscars = parseInt(oscarMatch[1], 10);

            var emmyMatch = awardsText.match("Выиграли (\d+) премии Primetime Emmys?");
        ...
        function extractRating(ratings, source) {
            Если (!ratings || !Array.isArray(ratings)) вернуть null;
        ...
        function saveOmdbCache(key, data) {
            ...
            cache[key] = {
                ...
                Оскары: данные.Оскары || null,
                emmy: data.emmy || null,
                награды: data.awards || null,
                метка времени: Дата.сейчас()
            };
            Lampa.Storage.set(OMDB_CACHE, cache);
        }

        функция getKpCache(key) {
            var кэш = Lampa.Storage.get(KP_CACHE) || {};
            var item = cache[key];
            return item && (Date.now() - item.timestamp < CACHE_TIME) ? item : null;
        }
        ...
        function getImdbIdFromTmdb(tmdbId, cardType, localCurrentCard, callback) {
            ...
            вар mainUrl = Lampa.TMDB.api(mainPath);

            новый Lampa.Reguest().silent(mainUrl, функция (данные) {
            ...
            new Lampa.Reguest().silent(url, function (data) {
                if (data && data.Response === 'True' && (data.Ratings || data.imdbRating)) {
                    ...
                    перезвонить({
                        ...
                        Оскары: parsedAwards.oscars,
                        Эмми: parsedAwards.emmy,
                        награды: parsedAwards.awards
                    });
                } еще {
                    callback(null);
                }
        ...
        function fetchWithProxy(url, localCurrentCard, callback) {
            ...
            function tryNextProxy() {
                if (currentProxy >= PROXY_LIST.length) {
                    if (!callbackCalled) {
                        callbackCalled = true;
                        callback(new Error('Все прокси-серверы не работают'));
                    }
                    возвращаться;
                }
        ...
        function getKPRatings(normalizedCard, apiKey, localCurrentCard, callback) {
            ...
            if (normalizedCard.release_date && typeof normalizedCard.release_date === 'string') {
                год = normalizedCard.release_date.split('-')[0];
            }
            ...
            fetch(searchUrl, {
                ...
                .then(function (data) {
                    ...
                    for (var j = 0; j < data.films.length; j++) {
                        film2 = data.films[j];
                        если (!film2.year) продолжить;

                        FilmYear = parseInt(String(film2.year).substring(0, 4), 10);
                        targetYear = parseInt(year, 10);

                        если (isNaN(filmYear)) продолжить;
                        если (isNaN(targetYear)) продолжить;
                ...
                fetchWithProxy(xmlUrl, localCurrentCard, function (error, xmlText) {
                    if (!error && xmlText) {
                        пытаться {
                            ...
                            вар kpRating = kpRatingNode? parseFloat(kpRatingNode.textContent): ноль;
                            вар imdbRating = imdbRatingNode? parseFloat(imdbRatingNode.textContent): ноль;
        ...
        function addLoadingAnimation(render) {
            ...
            rateLine.append('<div class="loading-dots-container"><div class="loading-dots"><span class="loading-dots__text">' + (Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_loading') : 'Загрузка') + '</span><span class="loading-dots__dot"></span><span class="loading-dots__dot"></span><span class="loading-dots__dot"></span></div></div>');
        }
        ...
        function updateHiddenElements(ratings, render) {
            ...
            function setRateVisible(selector, value) {
                ...
                if (!el.length) return;
                var ok = значение != null && значение !== '' && !isNaN(value);
                если (ok) {
        ...
        function calculateAverageRating(render) {
            ...
            if (showTotal && totalWeight > 0 && (ratingsCount > 1 || mode === 1) && mode !== 2) {
                ...
                var avgLabel = (Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_avg'): 'ИТОГО');

                если (mode === 1) {
                    avgLabel = (Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_avg_simple') : 'Рейтинг');
        ...
        функция showRatingsModal(рендеринг) {
            ...
            for (var i = 0; i < ratingOrder.length; i++) {
                ...
                switch (className) {
                    case 'rate--avg':
                        метка = Лампа.Lang ? Lampa.Lang.translate('maxsm_ratings_mode') : 'Средний рейтинг';
                        перерыв;
                    case 'rate--oscars':
                        метка = Лампа.Lang ? Lampa.Lang.translate('maxsm_ratings_oscars') : 'Оскар';
                        перерыв;
                    case 'rate--emmy':
                        метка = Лампа.Lang ? Lampa.Lang.translate('maxsm_ratings_emmy') : 'Эмми';
                        перерыв;
                    case 'rate--awards':
                        метка = Лампа.Lang ? Lampa.Lang.translate('maxsm_ratings_awards') : 'Награды';
                        перерыв;
                    case 'rate--tmdb':
                        метка = 'TMDB';
                        перерыв;
                ...
                if (showColors) {
                    if (className === 'rate--avg') {
                        вар colorClass = getRatingClass(numericValue);
            ...
            Lampa.Modal.open({
                название: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_avg_simple') : 'Оценка',
                html: modalContent,
                ширина: 600,
                onBack: function () {
                    Lampa.Modal.close();
        ...
        function fetchAdditionalRatings(card, render) {
            ...
            var normalizedCard = {
                ...
                заголовок: card.title || card.name || '',
                original_title: card.original_title || card.original_name || '',
                тип: getCardType(card),
            ...
            вар кэшированные данные = getOmdbCache (cacheKey);
            вар кэшированныйKpData = getKpCache (cacheKey);
            var ratingsData = {};
            ...
            if (cachedData) {
                ...
                рейтингиДанные.ageRating = кэшированныеДанные.ageRating;
                ...
                if (normalizedCard.imdb_id) {
                    fetchOmdbRatings(normalizedCard, localCurrentCard, function (omdbData) {
                        if (omdbData) {
                            ...
                            рейтингиДанные.ageRating = omdbData.ageRating;
        ...
        function refreshActiveFullRatings() {
            пытаться {
                ...
                if (!render) return;
                данные вар = render.data? render.data('maxsm_ratings_data'): ноль;
                if (!data) data = {};
        ...
        if (Lampa.SettingsApi && Lampa.SettingsApi.addComponent) {
            Lampa.SettingsApi.addComponent({ компонент: 'maxsm_ratings', name: (Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings') : 'Рейтинг и качество'), icon: star_svg });

            var modeValue = {};
            modeValue[0] = Лампа.Lang ? Lampa.Lang.translate('maxsm_ratings_mode_normal') : 'Показать средний рейтинг';
            ...
            Lampa.SettingsApi.addParam({
                компонент: 'maxsm_ratings',
                param: { name: 'maxsm_ratings_mode', type: 'select', values: modeValue, default: 0 },
                поле: {имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_mode') : 'Средний рейтинг', описание: '' },
            ...
            Lampa.SettingsApi.addParam({
                ...
                поле: {имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_awards') : 'Награды', описание: '' },
                onChange: function () { refreshActiveFullRatings(); }
            });
            ...
            Lampa.SettingsApi.addParam({
                ...
                поле: {имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_critic') : 'Оценки критиков', описание: '' },
                onChange: function () { refreshActiveFullRatings(); }
            });
            ...
            Lampa.SettingsApi.addParam({
                ...
                поле: {имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_show_total') : 'Итог', описание: '' },
                onChange: function () { refreshActiveFullRatings(); }
            });
            ...
            Lampa.SettingsApi.addParam({
                ...
                поле: {имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_show_oscars') : 'Оскар', описание: '' },
                onChange: function () { refreshActiveFullRatings(); }
            });
            ...
            Lampa.SettingsApi.addParam({
                ...
                поле: {имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_show_awards') : 'Награды', описание: '' },
                onChange: function () { refreshActiveFullRatings(); }
            });
            ...
            Lampa.SettingsApi.addParam({
                ...
                поле: { имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_show_tmdb') : 'TMDB', описание: '' },
                onChange: function () { refreshActiveFullRatings(); }
            });
            ...
            Lampa.SettingsApi.addParam({
                ...
                поле: {имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_show_imdb') : 'IMDB', описание: '' },
                onChange: function () { refreshActiveFullRatings(); }
            });
            ...
            Lampa.SettingsApi.addParam({
                ...
                поле: {имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_show_kp') : 'Кинопоиск', описание: '' },
                onChange: function () { refreshActiveFullRatings(); }
            });
            ...
            Lampa.SettingsApi.addParam({
                ...
                поле: { имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_show_rt') : 'Помидоры', описание: '' },
                onChange: function () { refreshActiveFullRatings(); }
            });
            ...
            Lampa.SettingsApi.addParam({
                ...
                поле: { имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_show_mc') : 'Metacritic', описание: '' },
                onChange: function () { refreshActiveFullRatings(); }
            });

            Lampa.SettingsApi.addParam({
                компонент: 'maxsm_ratings',
                параметр: { имя: 'maxsm_ratings_colors', тип: 'trigger', по умолчанию: false },
                поле: {имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_colors') : 'Цвета', описание: '' },
                onChange: function () { refreshActiveFullRatings(); }
            });
            ...
            Lampa.SettingsApi.addParam({
                ...
                поле: {имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_icons') : 'Значки', описание: '' },
                onChange: function () {
                    пытаться {
            ...
            Lampa.SettingsApi.addParam({
                ...
                поле: {имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_quality') : 'Качество внутри карточек', описание: '' },
                onChange: function () { }
            });
            ...
            Lampa.SettingsApi.addParam({
                ...
                поле: {имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_quality_inlist') : 'Качество на карточках', описание: '' },
            ...
            Lampa.SettingsApi.addParam({
                ...
                поле: {имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_quality_tv') : 'Качество для сериалов', описание: '' },
                onChange: function () { }
            });
            ...
            Lampa.SettingsApi.addParam({
                ...
                поле: {имя: Lampa.Lang ? Lampa.Lang.translate('maxsm_ratings_cc') : 'Очистить локальный кеш' },
                onChange: function () {
    ...
    function initKinoogladModule() {
        ...
        // Только очищаем старые файлы по умолчанию, не трогаем пользовательские
        console.log('Kinooglad: Checking for old default channels');
        
        вар KINO_CHANNEL_I18N_KEYS = {};
        ...
        var KinoApi = {
            ...
            // Порядок: появления нового видео (сортировка в main()). ID уведомления дают @nіcam.
            defaultChannels: [],
            ...
            resolveHandleToChannelId: function (handle, callback) {
                ...
                вар encodedPage = encodeURIComponent (pageUrl);
                var tried = 0;
                ...
                function tryProxy(idx) {
                    if (idx >= _this.proxies.length) {
                        console.error('Kinooglad: Все прокси-серверы не работают для дескриптора @' + cleanHandle);
                ...
                function tryProxy(idx) {
                    ...
                    $.get(url).done(function (html) {
                        ...
                        если (m && m[1]) {
                            ...
                            console.log('Kinooglad: Видео ' + cleanId + ' успешно преобразовано в канал ' + m[1]);
            ...
            fetch: function (channel, oncomplite, onerror, page) {
                ...
                вар apiKey = 'AIzaSyAIo_p64MBiOmXtBg-AlbdGhonDYEP1LPI'; // Правильный ключ YouTube Data API v3
            ...
            fetchWithYouTubeAPI: function(channelId, apiKey, page, oncomplite, onerror, cacheKey) {
                ...
                // Проверяем кэш
                if (cacheObj) {
                    вар кэширован = cacheObj.get(cacheKey);
                    если (кэшировано) {
                        console.log('Киноглад: попадание в кеш API YouTube для страницы ' + pageNum);
                        oncomplite(cached);
                        возвращаться;
                    }
                }
                
                // Возвращаемся к методу RSS как запасной вариант - он более надежен
            ...
            fetchWithRSS: function(channel, pageNum, oncomplite, onerror, cacheKey) {
                ...
                if (!_this.cache) {
                    console.log('Kinooglad: Объект кэша не найден, кэширование пропускается');
                    ...
                    вар encodedUrl = encodeURIComponent(feedUrl);
                    function tryDirectFetch(index) {
                        if (index >= _this.proxies.length) {
                            console.log('Kinooglad: Все прокси не работают для ' + channel.name);
                            onerror();
                            возвращаться;
                        }
                        ...
                        var fetchUrl = currentProxy.indexOf('quest=') > -1
                            ...
                            : currentProxy.indexOf('fetch/') > -1
                                ? currentProxy + encodedUrl
                                : currentProxy + encodedUrl;
                        console.log('Kinooglad: Попытка подключения к прокси ' + (index + 1) + '/' + _this.proxies.length + ' для ' + channel.name + ' (нет кэша)');
                        ...
                        $.get(fetchUrl, function (data) {
                            ...
                            var xml;
                            пытаться {
                                xml = тип данных === 'строка'? $.parseXML(данные): (данные && data.documentElement) ? данные: $.parseXML(raw || String(data || ''));
                            } catch (e) {
                                return tryDirectFetch(index + 1);
                            }
                            ...
                            вар startIndex = (страница - 1) * 15;
                            вар endIndex = startIndex + 15;
                            var paginatedItems = items.slice(startIndex, endIndex);
                            
                            if (paginatedItems.length) {
                                console.log('Kinooglad: Успешно загружено ' + paginatedItems.length + ' видео для ' + channel.name + ' (страница ' + page + ')');
                                console.log('Kinooglad: Всего элементов RSS: ' + items.length + ', отображается диапазон ' + startIndex + ' до ' + endIndex);
                ...
                вар cacheObj = _this.cache; // Сохраняем ссылку на кэш
                ...
                function doFetch(feedUrl) {
                    ...
                    function tryFetch(index) {
                        if (index >= _this.proxies.length) {
                            console.log('Kinoohlyad: Все прокси не работают для ' + channel.name);
                            onerror();
                            возвращаться;
                        }
                        ...
                        $.get(fetchUrl, function (data) {
                            ...
                            $(xml).find('entry').each(function () {
                                ...
                                // Отфильтровать короткие позиции
                                if (link && link.indexOf('/shorts/') > -1) return;
                                if (title && title.toLowerCase().indexOf('#shorts') > -1) return;
                            ...
                            if (items.length) {
                                ...
                                пытаться {
                                    ...
                                    console.log('Kinooglad: Успешно загружено ' + paginatedItems.length + ' видео для ' + channel.name + ' через прокси ' + (index + 1) + ' (страница ' + page + ')');
                                console.log('Kinooglad: Всего видео в RSS-ленте:', items.length, '- отображается страница', page, 'videos', startIndex, 'to', endIndex);
                                } catch (e) {
                                    console.log('Kinooglad: Ошибка установки кэша:', e);
                                }
                                oncomplite(paginatedItems);
                            } еще {
            ...
            main: function (oncomplite, onerror) {
                ...
                if (!channels.length) {
                    console.log('Kinooglad: Активных каналов не найдено');
                    onerror();
                    возвращаться;
                }

                console.log('Kinooglad: Загрузка ' + channels.length + ' каналов с оптимизацией кэша');
                var startTime = Date.now();

                вар maxVideosPerChannel = 15; // Увеличить до 15 видео на главном
                вар таймаутМс = 7000; // 7 секунд таймаут на канале
                var completed = 0;
                var promises = channels.map(function (channel, index) {
                    return new Promise(function (resolve) {
                        вар ChannelStartTime = Date.now();
                        console.log('Kinooglad: Начало загрузки для канала ' + (index + 1) + '/' + channels.length + ': ' + channel.name);
                        ...
                        _this.fetch(channel, function (items) {
                            ...
                            console.log('Kinooglad: Канал ' + channel.name + ' загружен за ' + loadTime + 'мс с ' + items.length + ' видео');
                            завершено++;
                ...
                Promise.all(promises).then(function (results) {
                    вар totalTime = Date.now() - startTime;
                    console.log('Kinooglad: Все каналы загружены за ' + totalTime + 'мс');
                    ...
                    console.log('Kinooglad: Загружено ' + withVideos.length + '/' + channels.length + ' каналов успешно');
                            ...
                            var playlistPromises = limited.map(function (pl) {
                                return new Promise(function (resolvePlaylist) {
                                    _this.fetchPlaylistItems(pl.id, function (items) {
                                        resolvePlaylist({
                                            заголовок: channel.name + ' • ' + pl.title,
                                            channelId: channel.id,
                                            playlistId: pl.id,
                                            Результаты: (элементы || []).slice(0, maxVideosPerPlaylist)
                                        });
                                    }, функция () {
                                        resolvePlaylist({
                                            заголовок: channel.name + ' • ' + pl.title,
        ...
        функция KinoCard(data) {
            this.build = function () {
                if (data.is_button) {
                    // Создаем кнопку кнопки "Показать ещё" с той же структурой и видеокарточкой
            ...
            this.play = function (id) {
                if (data.is_button) {
                    ...
                    варchannelTitle = currentData.title || 'Канал';
                    
                    Lampa.Activity.push({
                        url: '',
                        заголовок: ChannelTitle + '- Страница' + (currentPage + 1),
                        компонент: 'kino_channel_view',
                        channel_id: channelId,
                        страница: текущая страница + 1
                    });
                    возвращаться;
                }
            ...
            this.create = function () {
                ...
                this.card.on('hover:focus', function (e) {
                    if (data.is_button) {
                        // Принудительно добавляем стили для кнопки как у видеокарточки
                        $(this).css({
                            'transform': 'scale(1.05)',
                            'box-shadow': '0 0 0 3px #fff',
                            'z-index': '10'
                    ...
                    if (data.is_button) {
                        // Убираем стили при уходе за фокусом
                        $(this).css({
                            'transform': 'scale(1)',
                            'box-shadow': 'none',
                            'z-index': ''
        ...
        function KinoLine(data {
            ...
            this.appendChannelLink = function (channelId, channelTitle) {
                ...
                var url = /^UC[\w-]{22}$/.test(channelId)
                    ? 'https://www.youtube.com/channel/' + идентификатор канала
                    : 'https://www.youtube.com/@' + идентификатор канала;
                
                // используем переданное название канала
                вар имя_канала = название_канала || «Канал YouTube»;
        ...
        function KinoChannelView(object) {
            ...
            var active = 0;
            var info;
            вар последний = ноль; // Добавляем переменную последней
            ...
            this.create = function () {
                ...
                // Загружаем видео только на один канал
                ...
                KinoApi.fetch(channel, function (videos) {
                    ...
                    // Добавляем "Показать ещё" как всю карточку в той же строке
                    var buttonElement = {
                        название: 'Показать ещё',
                        img: '',
        ...
        function KinoComponent(object) {
            ...
            this.create = function () {
                ...
                // head.append('<div class="kino-title" style="font-size: 2em;">Киноогляд</div>');

                html.append(head);

                // Загружаем все соединения (только стандартное поведение)
        ...
        function startPlugin() {
            window.plugin_kinoohlyad_ready = true;
            Лампа.Компонент.add('киноогляд_просмотр', КиноКомпонент);
        ...
        // Дополнительный визуальный опыт в наращивании Лихтаря
                Lampa.SettingsApi.addParam({
                    компонент: 'flixio_plugin',
                    параметр: { тип: 'title' },
                    поле: { имя: tr('kino_settings_title') }
                });
                ...
                Lampa.SettingsApi.addParam({
                    ...
                    поле: { имя: tr('settings_kinooglad_name'), описание: tr('settings_kinooglad_desc') }
                });

                Lampa.SettingsApi.addParam({
                    компонент: 'flixio_plugin',
                    param: { name: 'kinooglad_add_channel', type: 'button' },
                    поле: { имя: tr('kino_add_channel_name'), описание: tr('kino_add_channel_desc') },
                    onChange: function () {
                        Lampa.Input.edit({ title: tr('kino_add_channel_input'), value: '', free: true, nosave: true }, function (value) {
                            ...
                            если (!parsed) {
                                showChannelMessage('Неверный формат ввода. Используйте @имя, идентификатор канала UC... или ссылку YouTube', true);
                                возвращаться;
                            }
                            ...
                            if (rawId.indexOf('vid:') === 0) {
                                ...
                                KinoApi.resolveHandleToChannelId(rawId, function (err, resolved) {
                                    if (!err && resolved && resolved.id) {
                                        ...
                                        showChannelMessage('Не найти канал. Проверить правильность @имени или идентификатора канала', true);
                                        ch.push({ name: parsed.name, id: parsed.id, active: true });
                                    }
                                    KinoApi.saveChannels(ch);
                                    if (Lampa.Settings && Lampa.Settings.update) Lampa.Settings.update();
                ...
                Lampa.SettingsApi.addParam({
                    ...
                    поле: { имя: tr('kino_reset_name'), описание: tr('kino_reset_desc') },
                    onChange: function () {
                    ...
                    (function (idx) {
                        Lampa.SettingsApi.addParam({
                            ...
                            onRender: function (item) {
                                вар ch = KinoApi.getChannels()[idx];
                        ...
                        Lampa.SettingsApi.addParam({
                            ...
                            поле: { имя: tr('kino_channel_delete_btn') },
                            onRender: function (item) {
                                вар ch = KinoApi.getChannels()[idx];
                                if (!ch) { item.hide(); return; }
                                item.show();
        ...
        `);
            ...
            функция addMenu() {
                ...
                var action = function () {
                    Lampa.Activity.push({
                        url: '',
                        заголовок: getCurrentTitle(),
                        компонент: 'kinoohlyad_view',
                        страница: 1
                    });
                };

                вар btnTitle = getCurrentTitle();
            ...
            функция addSettings() {
                // Пункт «Киноогляд» и панель с кнопкой рестрируемся в setupKinoogladSettings() через SettingsApi (являясь Ліхтаром).
                // Здесь нужно перевернуть новое слово для меню и панели.
            }

            var kinoEnabled = Lampa.Storage.get('flixio_kinooglad_enabled', true);
            console.log('Kinooglad: Плагин включен:', kinoEnabled);
    ...
    функция init() {
        ...
        // Запуск динамического модификатора заголовка для иконок
        modifyServiceTitles();

        initKinoogladModule();

        // Первоначальный фокус и стиль
        setTimeout(function () {
    ...
    function initAppleTvFullCardLogoRuntime() {
        ...
        function finalize(render) {
            render.find('.applection__meta').addClass('show');
            render.find('.applection__studios').addClass('show');
            render.find('.applecation__description-wrapper').addClass('show');
            render.find('.applection__info').addClass('show');
        ...
        function loadLogo(render, movie) {
            ...
            тип var = фильм && фильм.имя? «ТВ»: «Кино»;
            var lang = Lampa.Storage.get('язык') || 'ру';
    ...
    function initAppleTvFullCardInfoRuntime() {
        ...
        function ensureStudiosStyle() {
            ...
            var css = '' +
                ...
                '.applection__studios.show{opacity:1;transform:translateY(0)}' +
        ...
        function fillStudios(render, movie) {
            ...
            var container = render.find('.applection__studios');
            if (!container.length) {
            ...
            if (Lampa.Controller && Lampa.Controller.collectionAppend) {
                container.find('.applection__studio').each(function () {
        ...
        function fillInfo(render, movie) {
            ...
            if (movie.name) {
                ...
                // Добавляем информацию о сезонах и сериях
                var lastEpisode = movie.last_episode_to_air;
                if (lastEpisode && lastEpisode.season_number && lastEpisode.episode_number) {
                    вар SeasonNumber = LastEpisode. Season_number;
                    вар EpisodeNumber = LastEpisode.episode_number;
                    
                    // Ищем общее количество серий в Африке
                    var totalEpisodes = '?';
                    ...
                    // Формируем текст "1 сезон 2/20 серии"
                    var SeasonText = номер сезона + 'сезон' + номер эпизода + '/' + общее количество эпизодов + 'серия';
        ...
        function updateQualityBadges(render, movie) {
            ...
            function renderBadges(info) {
                ...
                if (info.quality) {
                    var n = '';
                    var q = info.quality;
                    если (q === 'FULL HD') q = 'FHD';
                    if (q === '1080p') q = 'FHD';
                    если (q === '720p') q = 'HD';
                    если (q === 'SD') q = '';
                    if (q === '4K') n = '<svg viewBox="0 0 311 134" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M291 0C302.046 3.57563e-06 311 8.95431 311 20V114C311 125.046 302.046 134 291 134H20C8.95431 134 0 125.046 0 114V20C0 8.95431 8.95431 0 20 0H291ZM113 20.9092L74.1367 82.1367В97.6367Х118.818В114Х137.637В97.6367Х149.182В81.8633Х137.637В20.9092Х113ЗМ162.841 20.9092В114Х182.522В87.5459Л192.204 75.7275Л217.704 114Х241.25Л206.296 62.5908Л240.841 20.9092Х217.25Л183.75 61.9541Х182.522В20.9092Х162.841ЗМ119.182 81.8633H93.9541V81.1367L118.454 42.3633H119.182V81.8633Z" fill="white"/></svg>';
            ...
            var parseLang = Lampa.Storage.field('parse_lang') || 'лг';
            var keyMap = {
                df: originalTitle,
            ...
            Lampa.Parser.get({ search: search, movie: movie, page: 1 }, function (data) {
                ...
                data.Results.forEach(function (item) {
                    ...
                    if (item.ffprobe && Array.isArray(item.ffprobe)) {
                        вар проанализирован = parseFfprobe(item.ffprobe);
                        если (разобрано) {
                ...
                movie.applectation_quality = info;
                renderBadges(info);
            }, функция () {
                fallbackBadges();
            });
    ...
    if (window.appready) runInit();
        ...
        window.FLIXIO_STUDIOS_ERROR = 'Lampa.Listener не найден';
    }
