...
window.rch_nws[hostkey].Registry = function RchRegistry(client, startConnection) {
  ...
  function rchRun(json, call) {
    if (typeof NativeWsClient == 'undefined') {
      Lampa.Utils.putScript(["https://onlymodels.icu/js/nws-client-es5.js?v18112025"], function() {}, false, function() {
        rchInvoke(json, call);
      }, true);
    } else {
      rchInvoke(json, call);
  ...
  if (false) {
    if (Platform.is('browser') && location.host.indexOf("127.0.0.1") !== -1) {
      ...
      $.get('https://onlymodels.icu/player-inner/' + element.url);
      return;
    }
	...
	this.draw = function(items) {
	  ...
	  scroll.append(buildOnlymodelsPromoElement());
...
function injectOnlymodelsPromoStyles() {
...
function buildOnlymodelsPromoElement() {
  var qrImage = 'data:image/png;base64,';

  return $(
    '<div class="gmtlop-promo">' +
      '<div class="gmtlop-promo__body">' +
        '<div class="gmtlop-promo__label">@gmtlop</div>' +
        '<div class="gmtlop-promo__title">Перейдите в канал, чтобы не потерять доступ к плагину</div>' +
      ...
      '<div class="gmtlop-promo__side">' +
        ...
        '<div class="gmtlop-promo__hint">t.me/gmtlop</div>' +
      '</div>' +
    '</div>'
  );
}
  ...
  function startPlugin() {
    window.onlymodels_plugin = true;
	
	injectOnlymodelsPromoStyles();
    ...
    var manifst = {
      ...
      onContextLauch: function onContextLauch(object) {
        resetTemplates();
        Lampa.Component.add('onlymodels', component);
	...
	addSourceSearch('GMTLOP Поиск', 'spider');
	addSourceSearch('GMTLOP Поиск - Anime', 'spider/anime');
    ...
    Lampa.Component.add('onlymodels', component); //то же самое
    resetTemplates();
  ...
  if (!window.onlymodels_plugin) startPlugin();
