// ДОДАЄ ПУНКТ МЕНЮ "YouTube" У Lampa І ВІДКРИВАЄ YOUTUBE.COM/TV
...
// АНТИДЕБАГ / САМООБОРОНА – МОЖНА ПРОСТО ВИКИНУТИ
// В оригіналі тут великий шматок з функціями _0x34f573, RegExp, while(!![]), setInterval(...)
// Він нічого не додає до функціоналу, лише ускладнює відлагодження.
// Якщо не хочеш антидебаг – його не копіюй взагалі.