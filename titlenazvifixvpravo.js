(function () {
  "use strict";
  // ===== Logging Helper =====  
  // orig url = https://BDVBurik.github.io/title.js
    ...
    function showTitles(card) {
      try {
        ...
        function renderTitles() {
          ...
          /* ОНОВЛЕНО: Додано стилі для примусового розтягування блоку на всю ширину та вирівнювання по правому краю (flex-end) */
          var titleStyle = 'width: 100% !important; align-self: stretch !important; margin-bottom: 7px; text-align: right !important; display: flex !important; flex-direction: column !important; align-items: flex-end !important;';

          $('.full-start-new__title', render).after(
            '<div class="original_title" style="' + titleStyle + '">'
            + lines.join('') + '</div>'
          );
        }
