...
settings: { url: 'http://spawnum.duckdns_org_59117', key: '2', parser_torrent_type: 'jackett' }
},
{
base: 'jacred_pro',
name: 'Jacred.pro',
...
{
base: 'jacred_cc',
name: 'Jacred.cc (Rutracker, Rutor support)',
settings: { url: 'jacred.cc', key: '', parser_torrent_type: 'jackett' }
},
{
base: 'jacred_lol',
name: 'Jackett.lol (Russian media focus)',
settings: { url: 'jackett.lol', key: '', parser_torrent_type: 'jackett' }
},
{
base: 'spawn_pp_ua',
...
{
base: 'jackett_toloka_to',
name: 'Jackett Toloka (Toloka, Ukrainian content)',
settings: { url: 'jackett.toloka.to', key: '', parser_torrent_type: 'jackett' }
}
];
...
if (window.bat_parser_modal_style) return;
window.bat_parser_modal_style = true;
var css =
